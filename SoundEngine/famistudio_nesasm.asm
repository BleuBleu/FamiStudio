...
FAMISTUDIO_EXP_NONE = 0
    ...
    .if (FAMISTUDIO_EXP_VRC7 + FAMISTUDIO_EXP_EPSM + FAMISTUDIO_EXP_N163 + FAMISTUDIO_EXP_FDS) != 0
...
famistudio_update_row:
    ...
    bcc .base_instrument
    .endif
    .if (FAMISTUDIO_EXP_FDS != 0) | (FAMISTUDIO_EXP_VRC7 != 0) | (FAMISTUDIO_EXP_N163 != 0) | (FAMISTUDIO_EXP_EPSM != 0)
    beq .dpcm
    .if FAMISTUDIO_EXP_FDS
    .fds_instrument:
...
.famistudio_special_code_jmp_lo:
    ...
    .endif
    .if FAMISTUDIO_USE_DELTA_COUNTER
        .byte LOW(.special_dmc_counter)                       ; $6f
    .else
        .byte LOW(.invalid_opcode)                            ; $6f
    .endif
...
.famistudio_special_code_jmp_hi:
    ...
    .endif
    .if FAMISTUDIO_USE_DELTA_COUNTER
        .byte HIGH(.special_dmc_counter)                      ; $6f
    .else
        .byte HIGH(.invalid_opcode)                           ; $6f
    .endif
