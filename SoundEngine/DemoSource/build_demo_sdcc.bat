...
%GBDK_HOME%\bin\lcc -Wb-min=0 -Wl-j -Wm-yoA -autobank -Wb-ext=.rel -Wl-j -Wl-w -Wm-yS -v -Wb-v -Wa-l -Wl-u -Wf-Iinclude -Wf-MMD -mmos6502:nes -c -o demo_sdcc_asminc.o demo_sdcc_asminc.s
