...
.instruments:
	.dw .env58,.env36,.env1,.env32
	.dw .env50,.env41,.env1,.env32
	.dw .env37,.env36,.env1,.env32
	.dw .env43,.env36,.env1,.env32
	.dw .env19,.env47,.env1,.env32
	.dw .env12,.env39,.env1,.env32
	.dw .env35,.env40,.env1,.env32
	.dw .env31,.env36,.env1,.env32
	.dw .env10,.env38,.env1,.env32
	.dw .env15,.env33,.env28,.env32
	.dw .env15,.env1,.env13,.env32
	.dw .env15,.env1,.env1,.env32
	.dw .env15,.env1,.env27,.env32
	.dw .env15,.env1,.env26,.env32
	.dw .env42,.env25,.env1,.env9
	.dw .env42,.env24,.env26,.env49
	.dw .env52,.env24,.env26,.env49
	.dw .env16,.env1,.env27,.env60
	.dw .env5,.env1,.env1,.env32
	.dw .env45,.env1,.env27,.env30
	.dw .env54,.env11,.env26,.env32
	.dw .env57,.env1,.env28,.env32
	.dw .env15,.env4,.env1,.env32
	.dw .env7,.env1,.env27,.env32
	.dw .env6,.env1,.env1,.env22
	.dw .env6,.env18,.env1,.env32
	.dw .env6,.env1,.env28,.env22
	.dw .env6,.env1,.env27,.env22
	.dw .env54,.env1,.env1,.env32
	.dw .env53,.env1,.env27,.env51
	.dw .env46,.env1,.env26,.env3
	.dw .env55,.env29,.env1,.env32
	.dw .env59,.env56,.env1,.env32
...
.song0ch0loop:
.ref2:
	.db $fb,LOW(.tempo_env6),HIGH(.tempo_env6),$7f,$64,LOW(.env17),HIGH(.env17),$a4,$25,$c5,$64,LOW(.env0),HIGH(.env0),$62,$27,$b1,$f9,$91,$64,LOW(.env17),HIGH(.env17),$2a,$ad
.ref3:
	.db $62,$2c,$f7,$b1,$f9,$91
.ref4:
	.db $67,$25,$c5,$64,LOW(.env0),HIGH(.env0),$62,$27,$b1,$f9,$91,$64,LOW(.env17),HIGH(.env17),$2a,$ad
	.db $ff,$05
	.dw .ref3
	.db $ff,$08
	.dw .ref4
...
.ref5:
	.db $67,$2c,$95
.ref6:
	.db $74,$64,LOW(.env44),HIGH(.env44),$96,$28,$f7,$c5
.ref7:
	.db $64,LOW(.env21),HIGH(.env21),$28,$f7,$c5
.ref8:
	.db $7f,$66,$9c,$24,$85,$00,$81,$18,$85,$00,$81,$18,$85,$00,$81,$18,$85,$00,$81,$18,$85,$00,$81,$18,$85,$00,$81,$18,$85,$00,$81,$1d,$9d,$00,$81,$1b,$91,$00,$81,$1a,$91,$00,$81,$1b,$91,$00,$81
.ref9:
...
.ref10:
	...
	.dw .ref9
.ref11:
	.db $64,LOW(.env14),HIGH(.env14),$aa,$2b,$dd,$64,LOW(.env2),HIGH(.env2),$2c,$dd
.ref12:
	.db $64,LOW(.env34),HIGH(.env34),$29,$dd,$64,LOW(.env48),HIGH(.env48),$2b,$ad,$64,LOW(.env23),HIGH(.env23),$2b,$ad
.ref13:
	.db $64,LOW(.env14),HIGH(.env14),$62,$2b,$dd,$64,LOW(.env2),HIGH(.env2),$2c,$dd
	.db $ff,$06
	.dw .ref12
	.db $ff,$04
	.dw .ref13
	...
	.dw .ref12
.ref14:
	.db $73,$66,$98,$30,$ad,$62,$61,$fe,$30,$48,$f7,$95
.ref15:
	.db $f7,$c7
.ref16:
...
.ref21:
	...
	.dw .ref21
.ref22:
	.db $64,LOW(.env8),HIGH(.env8),$b8,$24,$f7,$c5
.ref23:
	.db $64,LOW(.env20),HIGH(.env20),$22,$f7,$c5
.ref24:
	.db $64,LOW(.env8),HIGH(.env8),$24,$f7,$c5
	.db $ff,$03
	.dw .ref23
.ref25:
	.db $64,LOW(.env8),HIGH(.env8),$21,$f7,$c5
.ref26:
	.db $64,LOW(.env20),HIGH(.env20),$1f,$f7,$c5
	.db $ff,$03
	.dw .ref25
	.db $ff,$03
	.dw .ref26
.ref27:
	.db $66,$a8,$17,$85,$19,$85,$1b,$85,$1e,$85,$23,$85,$25,$85,$27,$85,$2a,$85,$2f,$85,$31,$85,$33,$85,$36,$85,$33,$85,$31,$85,$2f,$85,$2a,$85,$27,$85,$25,$85,$23,$85,$1e,$85,$1b,$85,$19,$85,$17,$85,$12,$85
.ref28:
...
.song0ch1loop:
.ref33:
	.db $74,$98,$30,$31,$9b,$61,$0d,$31,$2c,$91,$72,$61,$0d,$31,$2c,$91,$74,$32,$33,$9b,$61,$12,$33,$2c,$91,$72,$61,$12,$33,$2c,$91,$74,$34,$35,$36,$89,$63,LOW(.env61),HIGH(.env61),$9d,$63,LOW(.env32),HIGH(.env32),$65,$81
.ref34:
	.db $37,$38,$8d,$63,LOW(.env61),HIGH(.env61),$f7,$8b,$63,LOW(.env32),HIGH(.env32),$65,$81,$61,$0b,$38,$32,$91,$72,$61,$0b,$38,$32,$91
.ref35:
	.db $74,$9a,$3c,$3d,$9b,$61,$0e,$3d,$34,$91,$72,$61,$0e,$3d,$34,$91,$74,$3e,$3f,$9b,$61,$14,$3f,$32,$91,$72,$61,$14,$3f,$32,$91,$74,$40,$41,$42,$89,$63,LOW(.env61),HIGH(.env61),$9d,$63,LOW(.env32),HIGH(.env32),$65,$81
.ref36:
	.db $43,$44,$8d,$63,LOW(.env61),HIGH(.env61),$f7,$8b,$63,LOW(.env32),HIGH(.env32),$65,$81,$61,$0c,$44,$39,$91,$72,$61,$0c,$44,$39,$91
.ref37:
	.db $74,$98,$43,$44,$9b,$61,$0e,$44,$38,$91,$72,$61,$0e,$44,$38,$91,$74,$45,$46,$9b,$61,$12,$46,$36,$91,$72,$61,$12,$46,$36,$91,$74,$47,$48,$49,$87,$63,LOW(.env61),HIGH(.env61),$9f,$63,LOW(.env32),HIGH(.env32),$65,$81
.ref38:
	.db $4a,$4b,$8d,$63,LOW(.env61),HIGH(.env61),$f7,$8b,$63,LOW(.env32),HIGH(.env32),$65,$81,$61,$0b,$4b,$3d,$91,$72,$61,$0b,$4b,$3d,$91
.ref39:
	.db $00,$95
.ref40:
	.db $74,$46,$47,$97,$63,LOW(.env61),HIGH(.env61),$f7,$81,$63,LOW(.env32),HIGH(.env32),$65,$81,$61,$0b,$47,$3b,$91,$72,$61,$0b,$47,$3b,$91
.ref41:
	.db $74,$48,$49,$8d,$63,LOW(.env61),HIGH(.env61),$f7,$89,$63,LOW(.env32),HIGH(.env32),$65,$81,$61,$0a,$49,$3c,$93,$72,$61,$0b,$49,$3c,$91
.ref42:
