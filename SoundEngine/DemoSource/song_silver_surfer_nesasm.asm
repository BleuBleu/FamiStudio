...
.ref4:
	.db $67,$25,$c5,$64,LOW(.env0),HIGH(.env0),$62,$27,$b1,$f9,$91,$64,LOW(.env18),HIGH(.env18),$2a,$ad
	.db $ff,$05
	.dw .ref3
	.db $ff,$08
	.dw .ref4
...
.ref5:
	.db $67,$2c,$95
.ref6:
	.db $74,$64,LOW(.env45),HIGH(.env45),$96,$28,$f7,$c5
.ref7:
	.db $64,LOW(.env22),HIGH(.env22),$28,$f7,$c5
.ref8:
...
.ref10:
	...
	.dw .ref9
.ref11:
	.db $64,LOW(.env16),HIGH(.env16),$aa,$2b,$dd,$64,LOW(.env2),HIGH(.env2),$2c,$dd
.ref12:
	.db $64,LOW(.env33),HIGH(.env33),$29,$dd,$64,LOW(.env48),HIGH(.env48),$2b,$ad,$64,LOW(.env24),HIGH(.env24),$2b,$ad
.ref13:
	.db $64,LOW(.env16),HIGH(.env16),$62,$2b,$dd,$64,LOW(.env2),HIGH(.env2),$2c,$dd
	.db $ff,$06
	.dw .ref12
	.db $ff,$04
	.dw .ref13
	...
	.dw .ref12
.ref14:
	.db $73,$64,LOW(.env1),HIGH(.env1),$66,$98,$30,$ad,$62,$61,$fd,$30,$48,$f7,$95
.ref15:
	.db $f7,$c7
.ref16:
...
.ref21:
	...
	.dw .ref21
.ref22:
	.db $64,LOW(.env9),HIGH(.env9),$b8,$24,$f7,$c5
.ref23:
	.db $64,LOW(.env21),HIGH(.env21),$22,$f7,$c5
.ref24:
	.db $64,LOW(.env9),HIGH(.env9),$24,$f7,$c5
	.db $ff,$03
	.dw .ref23
.ref25:
	.db $64,LOW(.env9),HIGH(.env9),$21,$f7,$c5
.ref26:
	.db $64,LOW(.env21),HIGH(.env21),$1f,$f7,$c5
	.db $ff,$03
	.dw .ref25
	.db $ff,$03
	.dw .ref26
...
.song0ch1loop:
.ref33:
	.db $74,$98,$30,$31,$9b,$61,$0f,$31,$2c,$91,$72,$61,$0f,$31,$2c,$91,$74,$32,$33,$9b,$61,$13,$33,$2c,$91,$72,$61,$13,$33,$2c,$91,$74,$34,$35,$36,$89,$63,LOW(.env62),HIGH(.env62),$9d,$63,LOW(.env31),HIGH(.env31),$65,$81
.ref34:
	.db $37,$38,$8d,$63,LOW(.env62),HIGH(.env62),$f7,$8b,$63,LOW(.env31),HIGH(.env31),$65,$81,$61,$0c,$38,$32,$91,$72,$61,$0c,$38,$32,$91
.ref35:
	.db $74,$9a,$3c,$3d,$9b,$61,$0f,$3d,$34,$91,$72,$61,$0f,$3d,$34,$91,$74,$3e,$3f,$9b,$61,$16,$3f,$32,$91,$72,$61,$16,$3f,$32,$91,$74,$40,$41,$42,$89,$63,LOW(.env62),HIGH(.env62),$9d,$63,LOW(.env31),HIGH(.env31),$65,$81
.ref36:
	.db $43,$44,$8d,$63,LOW(.env62),HIGH(.env62),$f7,$8b,$63,LOW(.env31),HIGH(.env31),$65,$81,$61,$0d,$44,$39,$91,$72,$61,$0d,$44,$39,$91
.ref37:
	.db $74,$98,$43,$44,$9b,$61,$0f,$44,$38,$91,$72,$61,$0f,$44,$38,$91,$74,$45,$46,$9b,$61,$14,$46,$36,$91,$72,$61,$14,$46,$36,$91,$74,$47,$48,$49,$87,$63,LOW(.env62),HIGH(.env62),$9f,$63,LOW(.env31),HIGH(.env31),$65,$81
.ref38:
	.db $4a,$4b,$8d,$63,LOW(.env62),HIGH(.env62),$f7,$8b,$63,LOW(.env31),HIGH(.env31),$65,$81,$61,$0c,$4b,$3d,$91,$72,$61,$0c,$4b,$3d,$91
.ref39:
	.db $00,$95
.ref40:
	.db $74,$46,$47,$97,$63,LOW(.env62),HIGH(.env62),$f7,$81,$63,LOW(.env31),HIGH(.env31),$65,$81,$61,$0c,$47,$3b,$91,$72,$61,$0c,$47,$3b,$91
.ref41:
	.db $74,$48,$49,$8d,$63,LOW(.env62),HIGH(.env62),$f7,$89,$63,LOW(.env31),HIGH(.env31),$65,$81,$61,$0b,$49,$3c,$93,$72,$61,$0c,$49,$3c,$91
.ref42:
