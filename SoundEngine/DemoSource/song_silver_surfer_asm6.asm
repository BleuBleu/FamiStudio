...
@song0ch0loop:
@ref2:
	db $fb,<(@tempo_env6),>(@tempo_env6),$7f,$64,<(@env20),>(@env20),$a4,$25,$c5,$64,<(@env0),>(@env0),$62,$27,$b1,$f9,$91,$64,<(@env20),>(@env20),$2a,$ad
@ref3:
	db $62,$2c,$f7,$b1,$f9,$91
@ref4:
	db $67,$25,$c5,$64,<(@env0),>(@env0),$62,$27,$b1,$f9,$91,$64,<(@env20),>(@env20),$2a,$ad
	db $ff,$05
	dw @ref3
	db $ff,$08
	dw @ref4
...
@ref5:
	db $67,$2c,$95
@ref6:
	db $74,$64,<(@env13),>(@env13),$96,$28,$f7,$c5
@ref7:
	db $64,<(@env53),>(@env53),$28,$f7,$c5
@ref8:
...
@ref10:
	...
	dw @ref9
@ref11:
	db $64,<(@env14),>(@env14),$aa,$2b,$dd,$64,<(@env36),>(@env36),$2c,$dd
@ref12:
	db $64,<(@env6),>(@env6),$29,$dd,$64,<(@env33),>(@env33),$2b,$ad,$64,<(@env2),>(@env2),$2b,$ad
@ref13:
	db $64,<(@env14),>(@env14),$62,$2b,$dd,$64,<(@env36),>(@env36),$2c,$dd
	db $ff,$06
	dw @ref12
	db $ff,$04
	dw @ref13
	...
	dw @ref12
@ref14:
	db $73,$64,<(@env1),>(@env1),$66,$98,$30,$ad,$62,$61,$fe,$30,$48,$f7,$95
@ref15:
	db $f7,$c7
@ref16:
...
@ref21:
	...
	dw @ref21
@ref22:
	db $64,<(@env5),>(@env5),$b8,$24,$f7,$c5
@ref23:
	db $64,<(@env43),>(@env43),$22,$f7,$c5
@ref24:
	db $64,<(@env5),>(@env5),$24,$f7,$c5
	db $ff,$03
	dw @ref23
@ref25:
	db $64,<(@env5),>(@env5),$21,$f7,$c5
@ref26:
	db $64,<(@env43),>(@env43),$1f,$f7,$c5
	db $ff,$03
	dw @ref25
	db $ff,$03
	dw @ref26
...
@song0ch1loop:
@ref33:
	db $74,$98,$30,$31,$9b,$61,$0d,$31,$2c,$91,$72,$61,$0d,$31,$2c,$91,$74,$32,$33,$9b,$61,$12,$33,$2c,$91,$72,$61,$12,$33,$2c,$91,$74,$34,$35,$36,$89,$63,<(@env61),>(@env61),$9d,$63,<(@env29),>(@env29),$65,$81
@ref34:
	db $37,$38,$8d,$63,<(@env61),>(@env61),$f7,$8b,$63,<(@env29),>(@env29),$65,$81,$61,$0b,$38,$32,$91,$72,$61,$0b,$38,$32,$91
@ref35:
	db $74,$9a,$3c,$3d,$9b,$61,$0e,$3d,$34,$91,$72,$61,$0e,$3d,$34,$91,$74,$3e,$3f,$9b,$61,$14,$3f,$32,$91,$72,$61,$14,$3f,$32,$91,$74,$40,$41,$42,$89,$63,<(@env61),>(@env61),$9d,$63,<(@env29),>(@env29),$65,$81
@ref36:
	db $43,$44,$8d,$63,<(@env61),>(@env61),$f7,$8b,$63,<(@env29),>(@env29),$65,$81,$61,$0c,$44,$39,$91,$72,$61,$0c,$44,$39,$91
@ref37:
	db $74,$98,$43,$44,$9b,$61,$0e,$44,$38,$91,$72,$61,$0e,$44,$38,$91,$74,$45,$46,$9b,$61,$12,$46,$36,$91,$72,$61,$12,$46,$36,$91,$74,$47,$48,$49,$87,$63,<(@env61),>(@env61),$9f,$63,<(@env29),>(@env29),$65,$81
@ref38:
	db $4a,$4b,$8d,$63,<(@env61),>(@env61),$f7,$8b,$63,<(@env29),>(@env29),$65,$81,$61,$0b,$4b,$3d,$91,$72,$61,$0b,$4b,$3d,$91
@ref39:
	db $00,$95
@ref40:
	db $74,$46,$47,$97,$63,<(@env61),>(@env61),$f7,$81,$63,<(@env29),>(@env29),$65,$81,$61,$0b,$47,$3b,$91,$72,$61,$0b,$47,$3b,$91
@ref41:
	db $74,$48,$49,$8d,$63,<(@env61),>(@env61),$f7,$89,$63,<(@env29),>(@env29),$65,$81,$61,$0a,$49,$3c,$93,$72,$61,$0b,$49,$3c,$91
@ref42:
