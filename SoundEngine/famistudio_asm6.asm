...
.endif
.if FAMISTUDIO_EXP_S5B
famistudio_chn_s5b_env:            .dsb 6
famistudio_chn_s5b_env_lo:         .dsb 6
famistudio_chn_s5b_env_hi:         .dsb 6
famistudio_chn_s5b_env_repeat:     .dsb 6
famistudio_chn_s5b_env_ptr:        .dsb 6
.endif
.if FAMISTUDIO_EXP_EPSM
...
famistudio_chn_epsm_env:           .dsb 6
famistudio_chn_epsm_env_lo:        .dsb 6
famistudio_chn_epsm_env_hi:        .dsb 6
famistudio_chn_epsm_env_repeat:    .dsb 6
famistudio_chn_epsm_env_ptr:       .dsb 6
.endif
.if FAMISTUDIO_EXP_N163
