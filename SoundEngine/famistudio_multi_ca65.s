...
; [MULTI] BEGIN : Always enable all expansions, all the following code will assume that they are. We dont care about 
...
; [MULTI] BEGIN : We have all channels active : (2A03)+(VRC6)+(VRC7)+(FDS)+(MMC5)+(N163)+(S5B)
FAMISTUDIO_EXP_EPSM_CHANNELS    = 15
FAMISTUDIO_NUM_ENVELOPES        = (3+3+2+3)+(3+3+3)+(2+2+2+2+2+2)+(2)+(3+3)+(2+2+2+2+2+2+2+2)+(2+2+2)+(FAMISTUDIO_EXP_EPSM_CHANNELS*2)
...
FAMISTUDIO_NUM_DUTY_CYCLES      = (3)+(3)+(0)+(0)+(2)+(0)+(0)
; [MULTI] END
...
FAMISTUDIO_EXPANSION_CH3_IDX = 9;31 ;will need to check this
...
.if FAMISTUDIO_EXP_EPSM
    ...
    FAMISTUDIO_EPSM_CH9_PITCH_ENV_IDX = 35
    FAMISTUDIO_EPSM_CH10_PITCH_ENV_IDX = 36
    FAMISTUDIO_EPSM_CH11_PITCH_ENV_IDX = 37
    FAMISTUDIO_EPSM_CH12_PITCH_ENV_IDX = 38
    FAMISTUDIO_EPSM_CH13_PITCH_ENV_IDX = 39
    FAMISTUDIO_EPSM_CH14_PITCH_ENV_IDX = 40
.endif
...
.if FAMISTUDIO_EXP_EPSM
    ...
    FAMISTUDIO_EPSM_CHAN_RHYTHM_MAX = 43
.endif
.if FAMISTUDIO_EXP_FDS
...
.endif
.if FAMISTUDIO_EXP_EPSM
    FAMISTUDIO_EPSM_CH0_ENVS = 62
    FAMISTUDIO_EPSM_CH1_ENVS = 64
    FAMISTUDIO_EPSM_CH2_ENVS = 66
    FAMISTUDIO_EPSM_CH3_ENVS = 68
    FAMISTUDIO_EPSM_CH4_ENVS = 70
    FAMISTUDIO_EPSM_CH5_ENVS = 72
    FAMISTUDIO_EPSM_CH6_ENVS = 74
    FAMISTUDIO_EPSM_CH7_ENVS = 76
    FAMISTUDIO_EPSM_CH8_ENVS = 78
    FAMISTUDIO_EPSM_CH9_ENVS = 80
    FAMISTUDIO_EPSM_CH10_ENVS = 82
    FAMISTUDIO_EPSM_CH11_ENVS = 84
    FAMISTUDIO_EPSM_CH12_ENVS = 86
    FAMISTUDIO_EPSM_CH13_ENVS = 88
    FAMISTUDIO_EPSM_CH14_ENVS = 90
.endif
.if FAMISTUDIO_EXP_FDS
...
.if FAMISTUDIO_EXP_N163
    ...
    FAMISTUDIO_N163_CH1_ENVS = 42
    FAMISTUDIO_N163_CH2_ENVS = 44
    FAMISTUDIO_N163_CH3_ENVS = 46
    FAMISTUDIO_N163_CH4_ENVS = 48
    FAMISTUDIO_N163_CH5_ENVS = 50
    FAMISTUDIO_N163_CH6_ENVS = 52
    FAMISTUDIO_N163_CH7_ENVS = 54
.endif
.if FAMISTUDIO_EXP_S5B
    FAMISTUDIO_S5B_CH0_ENVS = 56
    FAMISTUDIO_S5B_CH1_ENVS = 58
    FAMISTUDIO_S5B_CH2_ENVS = 60
.endif
; [MULTI] END
...
.endif
    ...
    ; ldy @tmp_slide_from       ; reload note from [MULTI] Not needed.
.if FAMISTUDIO_DUAL_SUPPORT
    adc famistudio_pal_adjust
.endif
...
.if FAMISTUDIO_EXP_VRC7
    ...
    bcc @sec_and_done
    ; [MULTI] BEGIN : Additionnal range test.
    cpx #(FAMISTUDIO_VRC7_CH5_IDX+1)
    bcs @sec_and_done
    ; [MULTI] END
    lda #1
...
.if FAMISTUDIO_EXP_N163 || FAMISTUDIO_EXP_VRC7 || FAMISTUDIO_EXP_FDS
    cpx #5
    bcc @regular_channel_or_epsm
        lda #1
        sta famistudio_chn_inst_changed-5, x
    @regular_channel_or_epsm:
.endif
.if FAMISTUDIO_EXP_EPSM
    cpx #8
    bcc @regular_channel
...
.endif
.if FAMISTUDIO_EXP_EPSM
    .byte >famistudio_epsm_square_note_table_lsb
    .byte >famistudio_epsm_square_note_table_lsb
    .byte >famistudio_epsm_square_note_table_lsb
...
.endif
.if FAMISTUDIO_EXP_EPSM
    .byte <famistudio_epsm_square_note_table_msb
    .byte <famistudio_epsm_square_note_table_msb
    .byte <famistudio_epsm_square_note_table_msb
