...
call :CompileRomPermutation "FAMISTUDIO_CFG_DPCM_SUPPORT=1", "FAMISTUDIO_USE_VOLUME_TRACK=1", "FAMISTUDIO_USE_PITCH_TRACK=1" || goto Error
call :CompileRomPermutation "FAMISTUDIO_CFG_DPCM_SUPPORT=1", "FAMISTUDIO_USE_VOLUME_TRACK=1", "FAMISTUDIO_USE_PITCH_TRACK=1", "FAMISTUDIO_USE_SLIDE_NOTES=1" || goto Error
call :CompileRomPermutation "FAMISTUDIO_CFG_DPCM_SUPPORT=1", "FAMISTUDIO_USE_VOLUME_TRACK=1", "FAMISTUDIO_USE_PITCH_TRACK=1", "FAMISTUDIO_USE_SLIDE_NOTES=1", "FAMISTUDIO_USE_NOISE_SLIDE_NOTES=1" || goto Error
call :CompileRomPermutation "FAMISTUDIO_CFG_DPCM_SUPPORT=1", "FAMISTUDIO_USE_VOLUME_TRACK=1", "FAMISTUDIO_USE_PITCH_TRACK=1", "FAMISTUDIO_USE_SLIDE_NOTES=1", "FAMISTUDIO_USE_NOISE_SLIDE_NOTES=1", "FAMISTUDIO_USE_VIBRATO=1" || goto Error
call :CompileRomPermutation "FAMISTUDIO_CFG_DPCM_SUPPORT=1", "FAMISTUDIO_USE_VOLUME_TRACK=1", "FAMISTUDIO_USE_PITCH_TRACK=1", "FAMISTUDIO_USE_SLIDE_NOTES=1", "FAMISTUDIO_USE_NOISE_SLIDE_NOTES=1", "FAMISTUDIO_USE_VIBRATO=1", "FAMISTUDIO_USE_ARPEGGIO=1" || goto Error
call :CompileRomPermutation "FAMISTUDIO_CFG_DPCM_SUPPORT=1", "FAMISTUDIO_USE_VOLUME_TRACK=1", "FAMISTUDIO_USE_PITCH_TRACK=1", "FAMISTUDIO_USE_SLIDE_NOTES=1", "FAMISTUDIO_USE_NOISE_SLIDE_NOTES=1", "FAMISTUDIO_USE_VIBRATO=1", "FAMISTUDIO_USE_ARPEGGIO=1", "FAMISTUDIO_USE_DUTYCYCLE_EFFECT=1" || goto Error
call :CompileRomPermutation "FAMISTUDIO_CFG_DPCM_SUPPORT=1", "FAMISTUDIO_USE_FAMITRACKER_TEMPO=1" || goto Error
call :CompileRomPermutation "FAMISTUDIO_CFG_DPCM_SUPPORT=1", "FAMISTUDIO_USE_FAMITRACKER_TEMPO=1", "FAMISTUDIO_USE_FAMITRACKER_DELAYED_NOTES_OR_CUTS=1" || goto Error
