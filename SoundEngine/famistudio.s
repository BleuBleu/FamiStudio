...
;======================================================================================================================
    ...
    .ifdef FAMISTUDIO_ASSEMBLER_ASM6F
        .if FAMISTUDIO_ASSEMBLER_CA65
            error "Cannot define both FAMISTUDIO_ASSEMBLER_ASM6F and FAMISTUDIO_ASSEMBLER_CA65"
        .endif
        .if FAMISTUDIO_ASSEMBLER_NESASM
            error "Cannot define both FAMISTUDIO_ASSEMBLER_ASM6F and FAMISTUDIO_ASSEMBLER_NESASM"
        .endif
        FAMISTUDIO_ASSEMBLER_CA65 = 0
        FAMISTUDIO_ASSEMBLER_NESASM = 0
    .else

    .ifdef FAMISTUDIO_ASSEMBLER_CA65
        .ifdef FAMISTUDIO_ASSEMBLER_NESASM
            .error "Cannot define both FAMISTUDIO_ASSEMBLER_CA65 and FAMISTUDIO_ASSEMBLER_NESASM"
        .endif
        FAMISTUDIO_ASSEMBLER_ASM6F = 0
        FAMISTUDIO_ASSEMBLER_NESASM = 0
    .else
...
FAMISTUDIO_ASSEMBLER_CA65 = 0
        .else
            .error "Must define one of FAMISTUDIO_ASSEMBLER_ASM6F FAMISTUDIO_ASSEMBLER_CA65 or FAMISTUDIO_ASSEMBLER_NESASM"
        .endif ; FAMISTUDIO_ASSEMBLER_NESASM

    .endif ; FAMISTUDIO_ASSEMBLER_CA65

    .endif ; FAMISTUDIO_ASSEMBLER_ASM6F
...
.define ISBLANK .blank
.define ISNBLANK !.blank

.define MACRO_START  .macro
.define MACRO_END    .endmacro

.define START_RAM  .segment .string(FAMISTUDIO_CA65_RAM_SEGMENT)
.define END_RAM

.define START_ZP   .segment .string(FAMISTUDIO_CA65_ZP_SEGMENT) : zeropage
.define END_ZP

.define START_CODE .segment .string(FAMISTUDIO_CA65_CODE_SEGMENT)
.define END_CODE

; we have to hide these instructions in defines since asm6f parses them
.define FAMISTUDIO_CA65_ZP_DEFINE .xmatch(.string(FAMISTUDIO_CA65_ZP_SEGMENT), "FAMISTUDIO_CA65_ZP_SEGMENT")
.define FAMISTUDIO_CA65_RAM_DEFINE .xmatch(.string(FAMISTUDIO_CA65_RAM_SEGMENT), "FAMISTUDIO_CA65_RAM_SEGMENT")
.define FAMISTUDIO_CA65_CODE_DEFINE .xmatch(.string(FAMISTUDIO_CA65_CODE_SEGMENT), "FAMISTUDIO_CA65_CODE_SEGMENT")
...
MACRO_START  EQU .macro
MACRO_END    EQU .endm

START_ZP   EQU .enum FAMISTUDIO_ASM6_ZP_ENUM
END_ZP     EQU .ende
START_RAM  EQU .enum FAMISTUDIO_ASM6_BSS_ENUM
END_RAM    EQU .ende
START_CODE EQU .base FAMISTUDIO_ASM6_CODE_BASE
END_CODE   EQU +     ; dummy label

; FAMISTUDIO_ASSEMBLER_CA65 = 0
FAMISTUDIO_CA65_ZP_DEFINE = 0
FAMISTUDIO_CA65_RAM_DEFINE = 0 
FAMISTUDIO_CA65_CODE_DEFINE = 0 

; .local is not needed in asm6 as macros make local labels by default so this just ignores the param
MACRO_START DLOCAL v
MACRO_END
...
;     .endif
; START_ZP   = .enum FAMISTUDIO_ASM6_ZP_ENUM
; END_ZP     = .ende
; START_RAM  = .enum FAMISTUDIO_ASM6_BSS_ENUM
; END_RAM    = .ende
; START_CODE = .base FAMISTUDIO_ASM6_CODE_BASE
; END_CODE   = +     ; dummy label
...
FAMISTUDIO_CFG_NTSC_SUPPORT = 1
    ...
    .if FAMISTUDIO_CFG_NTSC_SUPPORT DAND FAMISTUDIO_CFG_PAL_SUPPORT
...
FAMISTUDIO_EXP_NOTE_START = 7
    ...
    .if FAMISTUDIO_USE_NOISE_SLIDE_NOTES DAND (FAMISTUDIO_USE_SLIDE_NOTES = 0)
    .error "Noise slide notes can only be used when regular slide notes are enabled too."
    .endif

    .if FAMISTUDIO_USE_VOLUME_SLIDES DAND (FAMISTUDIO_USE_VOLUME_TRACK = 0)
    .error "Volume slides can only be used when the volume track is enabled too."
    .endif

    .if FAMISTUDIO_USE_FAMITRACKER_DELAYED_NOTES_OR_CUTS DAND (FAMISTUDIO_USE_FAMITRACKER_TEMPO = 0)
    ...
    .if FAMISTUDIO_EXP_N163 DAND ((FAMISTUDIO_EXP_N163_CHN_CNT < 1) || (FAMISTUDIO_EXP_N163_CHN_CNT > 8))
    .error "N163 only supports between 1 and 8 channels."
    .endif

    .if FAMISTUDIO_USE_DELTA_COUNTER DAND (FAMISTUDIO_CFG_DPCM_SUPPORT = 0)
    .error "Delta counter only makes sense if DPCM samples are enabled."
    .endif

    .if FAMISTUDIO_USE_DPCM_BANKSWITCHING DAND (FAMISTUDIO_CFG_DPCM_SUPPORT = 0)
...
famistudio_r0:   DRES 1
famistudio_r1:   DRES 1
famistudio_r2:   DRES 1
famistudio_r3:   DRES 1

famistudio_ptr0: DRES 2
famistudio_ptr1: DRES 2
    .if FAMISTUDIO_EXP_EPSM || FAMISTUDIO_EXP_FDS || FAMISTUDIO_EXP_S5B
famistudio_ptr2: DRES 2
    .endif
...
famistudio_env_value:             DRES FAMISTUDIO_NUM_ENVELOPES
famistudio_env_repeat:            DRES FAMISTUDIO_NUM_ENVELOPES
famistudio_env_addr_lo:           DRES FAMISTUDIO_NUM_ENVELOPES
famistudio_env_addr_hi:           DRES FAMISTUDIO_NUM_ENVELOPES
famistudio_env_ptr:               DRES FAMISTUDIO_NUM_ENVELOPES

famistudio_pitch_env_value_lo:    DRES FAMISTUDIO_NUM_PITCH_ENVELOPES
famistudio_pitch_env_value_hi:    DRES FAMISTUDIO_NUM_PITCH_ENVELOPES
famistudio_pitch_env_repeat:      DRES FAMISTUDIO_NUM_PITCH_ENVELOPES
famistudio_pitch_env_addr_lo:     DRES FAMISTUDIO_NUM_PITCH_ENVELOPES
famistudio_pitch_env_addr_hi:     DRES FAMISTUDIO_NUM_PITCH_ENVELOPES
famistudio_pitch_env_ptr:         DRES FAMISTUDIO_NUM_PITCH_ENVELOPES
    .if FAMISTUDIO_USE_PITCH_TRACK
famistudio_pitch_env_fine_value:  DRES FAMISTUDIO_NUM_PITCH_ENVELOPES
    .endif

    .if FAMISTUDIO_USE_SLIDE_NOTES
famistudio_slide_step:            DRES FAMISTUDIO_NUM_SLIDES
famistudio_slide_pitch_lo:        DRES FAMISTUDIO_NUM_SLIDES
famistudio_slide_pitch_hi:        DRES FAMISTUDIO_NUM_SLIDES
    .endif

famistudio_chn_ptr_lo:            DRES FAMISTUDIO_NUM_CHANNELS
famistudio_chn_ptr_hi:            DRES FAMISTUDIO_NUM_CHANNELS
famistudio_chn_note:              DRES FAMISTUDIO_NUM_CHANNELS
famistudio_chn_repeat:            DRES FAMISTUDIO_NUM_CHANNELS
famistudio_chn_return_lo:         DRES FAMISTUDIO_NUM_CHANNELS
famistudio_chn_return_hi:         DRES FAMISTUDIO_NUM_CHANNELS
famistudio_chn_ref_len:           DRES FAMISTUDIO_NUM_CHANNELS
    .if FAMISTUDIO_USE_VOLUME_TRACK
famistudio_chn_volume_track:      DRES FAMISTUDIO_NUM_CHANNELS
    .if FAMISTUDIO_USE_VOLUME_SLIDES
famistudio_chn_volume_slide_step:   DRES FAMISTUDIO_NUM_VOLUME_SLIDES
famistudio_chn_volume_slide_target: DRES FAMISTUDIO_NUM_VOLUME_SLIDES
    .endif
    .endif
    .if FAMISTUDIO_USE_VIBRATO || FAMISTUDIO_USE_ARPEGGIO
famistudio_chn_env_override:      DRES FAMISTUDIO_NUM_CHANNELS ; bit 7 = pitch, bit 0 = arpeggio.
    .endif
    .if FAMISTUDIO_USE_FAMITRACKER_DELAYED_NOTES_OR_CUTS
famistudio_chn_note_delay:        DRES FAMISTUDIO_NUM_CHANNELS
famistudio_chn_cut_delay:         DRES FAMISTUDIO_NUM_CHANNELS
    .endif
    .if FAMISTUDIO_CFG_EQUALIZER
famistudio_chn_note_counter:      DRES FAMISTUDIO_NUM_CHANNELS
    .endif
    .if FAMISTUDIO_USE_PHASE_RESET
famistudio_phase_reset:           DRES 1 ; bit 0/1 = 2a03, bit 2/3/4 = vrc6, 5/6 = mmc5, bit 7 = fds
    .if FAMISTUDIO_EXP_N163
famistudio_phase_reset_n163:      DRES 1 ; bit 0...7 = n163
    .endif
    .endif
    .if FAMISTUDIO_USE_DELTA_COUNTER
famistudio_dmc_delta_counter:     DRES 1
    .endif
    .if FAMISTUDIO_EXP_VRC6
famistudio_vrc6_saw_volume:       DRES 1 ; -1 = 1/4, 0 = 1/2, 1 = Full
    .if FAMISTUDIO_USE_PHASE_RESET
famistudio_vrc6_pulse1_prev_hi:   DRES 1
famistudio_vrc6_pulse2_prev_hi:   DRES 1
famistudio_vrc6_saw_prev_hi:      DRES 1
.else
...
famistudio_vrc6_saw_prev_hi    = famistudio_vrc6_saw_volume
    ...
    .endif
    .if FAMISTUDIO_EXP_VRC7
famistudio_chn_vrc7_prev_hi:      DRES 6
famistudio_chn_vrc7_patch:        DRES 6
famistudio_chn_vrc7_trigger:      DRES 6 ; bit 0 = new note triggered, bit 7 = note released.
    .endif
    .if FAMISTUDIO_EXP_EPSM
famistudio_chn_epsm_rhythm_volume: DRES FAMISTUDIO_EXP_EPSM_RHYTHM_CNT
famistudio_chn_epsm_rhythm_stereo: DRES FAMISTUDIO_EXP_EPSM_RHYTHM_CNT
famistudio_chn_epsm_trigger:       DRES FAMISTUDIO_EXP_EPSM_FM_CHN_CNT + FAMISTUDIO_EXP_EPSM_RHYTHM_CNT ; bit 0 = new note triggered, bit 7 = note released.
famistudio_chn_epsm_fm_stereo:     DRES FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_fm_instrument: DRES FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_alg:           DRES FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_vol_op1:       DRES FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_vol_op2:       DRES FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_vol_op3:       DRES FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
famistudio_chn_epsm_vol_op4:       DRES FAMISTUDIO_EXP_EPSM_FM_CHN_CNT
    .endif
    .if FAMISTUDIO_EXP_N163
famistudio_chn_n163_instrument:   DRES FAMISTUDIO_EXP_N163_CHN_CNT
famistudio_chn_n163_wave_index:   DRES FAMISTUDIO_EXP_N163_CHN_CNT
famistudio_chn_n163_wave_len:     DRES FAMISTUDIO_EXP_N163_CHN_CNT
    .endif
    .if FAMISTUDIO_EXP_S5B
famistudio_s5b_env_period_lo:     DRES 1
famistudio_s5b_env_period_hi:     DRES 1
famistudio_s5b_chn_env_shape:     DRES 3 ; bit 7 = note attack.
famistudio_s5b_chn_env_octave:    DRES 3
    .endif
    .if FAMISTUDIO_USE_DUTYCYCLE_EFFECT
famistudio_duty_cycle:            DRES FAMISTUDIO_NUM_DUTY_CYCLES
    .endif

    .if FAMISTUDIO_USE_FAMITRACKER_TEMPO
famistudio_tempo_step_lo:         DRES 1
famistudio_tempo_step_hi:         DRES 1
famistudio_tempo_acc_lo:          DRES 1
famistudio_tempo_acc_hi:          DRES 1
    .if FAMISTUDIO_USE_FAMITRACKER_DELAYED_NOTES_OR_CUTS
famistudio_tempo_advance_row:     DRES 1
    .endif
.else
famistudio_tempo_env_ptr_lo:      DRES 1
famistudio_tempo_env_ptr_hi:      DRES 1
famistudio_tempo_env_counter:     DRES 1
famistudio_tempo_env_idx:         DRES 1
famistudio_tempo_frame_num:       DRES 1
famistudio_tempo_frame_cnt:       DRES 1
    .endif

famistudio_pal_adjust:            DRES 1
famistudio_song_list_lo:          DRES 1
famistudio_song_list_hi:          DRES 1
famistudio_instrument_lo:         DRES 1
famistudio_instrument_hi:         DRES 1
famistudio_dpcm_list_lo:          DRES 1 ; TODO: Not needed if DPCM support is disabled.
famistudio_dpcm_list_hi:          DRES 1 ; TODO: Not needed if DPCM support is disabled.
famistudio_dpcm_effect:           DRES 1 ; TODO: Not needed if DPCM support is disabled.
famistudio_pulse1_prev:           DRES 1
famistudio_pulse2_prev:           DRES 1
famistudio_song_speed:            DRES 1

    .if FAMISTUDIO_EXP_MMC5
famistudio_mmc5_pulse1_prev:      DRES 1
famistudio_mmc5_pulse2_prev:      DRES 1
    .endif

    .if FAMISTUDIO_EXP_FDS
famistudio_fds_mod_speed:         DRES 2
famistudio_fds_mod_depth:         DRES 1
famistudio_fds_mod_delay:         DRES 1
famistudio_fds_override_flags:    DRES 1 ; Bit 7 = mod speed overriden, bit 6 mod depth overriden
    .if FAMISTUDIO_USE_PHASE_RESET
famistudio_fds_prev_hi:           DRES 1
    .endif
    .endif

    .if FAMISTUDIO_EXP_VRC7
famistudio_vrc7_dummy:            DRES 1 ; TODO: Find a dummy address i can simply write to without side effects.
    .endif
...
famistudio_exp_instrument_lo:     DRES 1
famistudio_exp_instrument_hi:     DRES 1
    .endif

    .if FAMISTUDIO_CFG_SFX_SUPPORT

famistudio_output_buf:     DRES 11
famistudio_sfx_addr_lo:    DRES 1
famistudio_sfx_addr_hi:    DRES 1
famistudio_sfx_base_addr:  DRES (FAMISTUDIO_CFG_SFX_STREAMS * FAMISTUDIO_SFX_STRUCT_SIZE)
...
MACRO_START famistudio_get_note_pitch_macro pitch_env_offset, pitch_shift, note_table_lsb, note_table_msb
...
MACRO_START famistudio_smooth_vibrato pulse_lo, pulse_prev, reg_hi, reg_lo, reg_sweep

    DLOCAL @hi_delta_too_big
    DLOCAL @done
...
MACRO_START famistudio_update_channel_sound idx, env_offset, pulse_prev, reg_hi, reg_lo, reg_vol, reg_sweep

    DLOCAL @pitch
    DLOCAL @tmp
    DLOCAL @nocut
    DLOCAL @set_volume
    DLOCAL @compute_volume
    DLOCAL @hi_delta_too_big
    DLOCAL @noise_slide_shift_loop
    DLOCAL @no_noise_slide
...
.else
    ...
    .if FAMISTUDIO_EXP_VRC6 DAND idx = FAMISTUDIO_VRC6_CH2_IDX
    ...
    .if idx >= FAMISTUDIO_VRC6_CH0_IDX DAND idx <= FAMISTUDIO_VRC6_CH2_IDX 
        .if FAMISTUDIO_USE_PHASE_RESET
            sta pulse_prev
        .endif
        ora #$80
    .else
        .if (ISNBLANK(pulse_prev)) DAND ((!FAMISTUDIO_CFG_SFX_SUPPORT) || (ISBLANK(reg_sweep)))
            .if (ISNBLANK(reg_sweep)) DAND FAMISTUDIO_CFG_SMOOTH_VIBRATO
    ...
    .if (ISBLANK(pulse_prev)) || (ISBLANK(reg_sweep)) || FAMISTUDIO_CFG_SFX_SUPPORT || (!FAMISTUDIO_CFG_SMOOTH_VIBRATO)
    sta reg_hi
    .endif
...
@set_volume:
    ...
    .if idx = 0 || idx = 1 || idx = 3 || (FAMISTUDIO_EXP_MMC5 DAND (idx = FAMISTUDIO_MMC5_CH0_IDX || idx = FAMISTUDIO_MMC5_CH1_IDX))
    ldx famistudio_env_value+env_offset+FAMISTUDIO_ENV_DUTY_OFF
    ora famistudio_duty_lookup, x
.elseif FAMISTUDIO_EXP_VRC6 DAND (idx = FAMISTUDIO_VRC6_CH0_IDX || idx = FAMISTUDIO_VRC6_CH1_IDX)
    ldx famistudio_env_value+env_offset+FAMISTUDIO_ENV_DUTY_OFF
...
famistudio_vrc7_reg_table_lo:
    DBYTE FAMISTUDIO_VRC7_REG_LO_1, FAMISTUDIO_VRC7_REG_LO_2, FAMISTUDIO_VRC7_REG_LO_3, FAMISTUDIO_VRC7_REG_LO_4, FAMISTUDIO_VRC7_REG_LO_5, FAMISTUDIO_VRC7_REG_LO_6
famistudio_vrc7_reg_table_hi:
    DBYTE FAMISTUDIO_VRC7_REG_HI_1, FAMISTUDIO_VRC7_REG_HI_2, FAMISTUDIO_VRC7_REG_HI_3, FAMISTUDIO_VRC7_REG_HI_4, FAMISTUDIO_VRC7_REG_HI_5, FAMISTUDIO_VRC7_REG_HI_6
famistudio_vrc7_vol_table:
    DBYTE FAMISTUDIO_VRC7_REG_VOL_1, FAMISTUDIO_VRC7_REG_VOL_2, FAMISTUDIO_VRC7_REG_VOL_3, FAMISTUDIO_VRC7_REG_VOL_4, FAMISTUDIO_VRC7_REG_VOL_5, FAMISTUDIO_VRC7_REG_VOL_6
famistudio_vrc7_env_table:
    DBYTE FAMISTUDIO_VRC7_CH0_ENVS, FAMISTUDIO_VRC7_CH1_ENVS, FAMISTUDIO_VRC7_CH2_ENVS, FAMISTUDIO_VRC7_CH3_ENVS, FAMISTUDIO_VRC7_CH4_ENVS, FAMISTUDIO_VRC7_CH5_ENVS 
famistudio_vrc7_invert_vol_table:
    DBYTE $0f, $0e, $0d, $0c, $0b, $0a, $09, $08, $07, $06, $05, $04, $03, $02, $01, $00
...
famistudio_epsm_vol_table_op1:
    DBYTE FAMISTUDIO_EPSM_REG_TL, FAMISTUDIO_EPSM_REG_TL+1, FAMISTUDIO_EPSM_REG_TL+2,FAMISTUDIO_EPSM_REG_TL, FAMISTUDIO_EPSM_REG_TL+1, FAMISTUDIO_EPSM_REG_TL+2
famistudio_epsm_vol_table_op2:
    DBYTE FAMISTUDIO_EPSM_REG_TL+8, FAMISTUDIO_EPSM_REG_TL+1+8, FAMISTUDIO_EPSM_REG_TL+2+8,FAMISTUDIO_EPSM_REG_TL+8, FAMISTUDIO_EPSM_REG_TL+1+8, FAMISTUDIO_EPSM_REG_TL+2+8
famistudio_epsm_vol_table_op3:
    DBYTE FAMISTUDIO_EPSM_REG_TL+4, FAMISTUDIO_EPSM_REG_TL+1+4, FAMISTUDIO_EPSM_REG_TL+2+4,FAMISTUDIO_EPSM_REG_TL+4, FAMISTUDIO_EPSM_REG_TL+1+4, FAMISTUDIO_EPSM_REG_TL+2+4
famistudio_epsm_vol_table_op4:
    DBYTE FAMISTUDIO_EPSM_REG_TL+12, FAMISTUDIO_EPSM_REG_TL+1+12, FAMISTUDIO_EPSM_REG_TL+2+12,FAMISTUDIO_EPSM_REG_TL+12, FAMISTUDIO_EPSM_REG_TL+1+12, FAMISTUDIO_EPSM_REG_TL+2+12
famistudio_epsm_fm_vol_table:
    DBYTE $7e, $65, $50, $3f, $32, $27, $1e, $17, $12, $0d, $09, $06, $04, $02, $01, $00
...
famistudio_epsm_rhythm_key_table:
    DBYTE $01,$02,$04,$08,$10,$20
famistudio_epsm_rhythm_reg_table:
    DBYTE FAMISTUDIO_EPSM_REG_RHY_BD, FAMISTUDIO_EPSM_REG_RHY_SD, FAMISTUDIO_EPSM_REG_RHY_TC, FAMISTUDIO_EPSM_REG_RHY_HH, FAMISTUDIO_EPSM_REG_RHY_TOM, FAMISTUDIO_EPSM_REG_RHY_RIM
famistudio_epsm_reg_table_lo:
    DBYTE FAMISTUDIO_EPSM_REG_FN_LO, FAMISTUDIO_EPSM_REG_FN_LO2, FAMISTUDIO_EPSM_REG_FN_LO3, FAMISTUDIO_EPSM_REG_FN_LO, FAMISTUDIO_EPSM_REG_FN_LO2, FAMISTUDIO_EPSM_REG_FN_LO3
famistudio_epsm_reg_table_hi:
    DBYTE FAMISTUDIO_EPSM_REG_FN_HI, FAMISTUDIO_EPSM_REG_FN_HI2, FAMISTUDIO_EPSM_REG_FN_HI3, FAMISTUDIO_EPSM_REG_FN_HI, FAMISTUDIO_EPSM_REG_FN_HI2, FAMISTUDIO_EPSM_REG_FN_HI3
famistudio_epsm_vol_table:
    DBYTE FAMISTUDIO_EPSM_REG_VOL_1, FAMISTUDIO_EPSM_REG_VOL_2, FAMISTUDIO_EPSM_REG_VOL_3, FAMISTUDIO_EPSM_REG_VOL_4, FAMISTUDIO_EPSM_REG_VOL_5, FAMISTUDIO_EPSM_REG_VOL_6
famistudio_epsm_fm_env_table:
    DBYTE FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET
    DBYTE FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET + 2
    DBYTE FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET + 4
    DBYTE FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET + 6
    DBYTE FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET + 8
    DBYTE FAMISTUDIO_EPSM_CH0_ENVS + FM_ENV_OFFSET + 10
famistudio_epsm_register_order:
    DBYTE $50, $30, $B4, $B0, $60, $70, $80, $90, $38, $58, $68, $78, $88, $98, $34, $54, $64, $74, $84, $94, $3c, $5c, $6c, $7c, $8c, $9c, $40, $48, $44, $4c, $22 ;40,48,44,4c replaced for not sending data there during instrument updates,
famistudio_epsm_channel_key_table:
    DBYTE $f0, $f1, $f2, $f4, $f5, $f6
    .if FAMISTUDIO_EXP_EPSM_SSG_CHN_CNT > 0
famistudio_epsm_sqr_reg_table_lo:
    DBYTE FAMISTUDIO_EPSM_REG_LO_A, FAMISTUDIO_EPSM_REG_LO_B, FAMISTUDIO_EPSM_REG_LO_C
famistudio_epsm_sqr_reg_table_hi:
    DBYTE FAMISTUDIO_EPSM_REG_HI_A, FAMISTUDIO_EPSM_REG_HI_B, FAMISTUDIO_EPSM_REG_HI_C
famistudio_epsm_square_vol_table:
    DBYTE FAMISTUDIO_EPSM_REG_VOL_A, FAMISTUDIO_EPSM_REG_VOL_B, FAMISTUDIO_EPSM_REG_VOL_C
famistudio_epsm_square_env_table:
    DBYTE FAMISTUDIO_EPSM_CH0_ENVS, FAMISTUDIO_EPSM_CH1_ENVS, FAMISTUDIO_EPSM_CH2_ENVS
...
;======================================================================================================================
MACRO_START famistudio_epsm_write_patch_registers select, write

    DLOCAL @loop_main_patch
    DLOCAL @loop_extra_patch
    DLOCAL @alg_4
    DLOCAL @alg_5_6
    DLOCAL @alg_0_1_2_3
    ...
    @loop_extra_patch:
        ...
        sta select ; 4
        lda (famistudio_ptr2),y ; 5
        sta write ; 4
        dey	; 2
        nop	; 2 DELAY FOR MESEN-X
        bpl @loop_extra_patch ; 3  ; =26

    ldx famistudio_r2 ; @chan_idx2
...
famistudio_n163_freq_table_lo:
    DBYTE FAMISTUDIO_N163_REG_FREQ_LO - $00
    DBYTE FAMISTUDIO_N163_REG_FREQ_LO - $08
    DBYTE FAMISTUDIO_N163_REG_FREQ_LO - $10
    DBYTE FAMISTUDIO_N163_REG_FREQ_LO - $18
    DBYTE FAMISTUDIO_N163_REG_FREQ_LO - $20
    DBYTE FAMISTUDIO_N163_REG_FREQ_LO - $28
    DBYTE FAMISTUDIO_N163_REG_FREQ_LO - $30
    DBYTE FAMISTUDIO_N163_REG_FREQ_LO - $38
famistudio_n163_freq_table_mid:
    DBYTE FAMISTUDIO_N163_REG_FREQ_MID - $00
    DBYTE FAMISTUDIO_N163_REG_FREQ_MID - $08
    DBYTE FAMISTUDIO_N163_REG_FREQ_MID - $10
    DBYTE FAMISTUDIO_N163_REG_FREQ_MID - $18
    DBYTE FAMISTUDIO_N163_REG_FREQ_MID - $20
    DBYTE FAMISTUDIO_N163_REG_FREQ_MID - $28
    DBYTE FAMISTUDIO_N163_REG_FREQ_MID - $30
    DBYTE FAMISTUDIO_N163_REG_FREQ_MID - $38
famistudio_n163_freq_table_hi:
    DBYTE FAMISTUDIO_N163_REG_FREQ_HI - $00
    DBYTE FAMISTUDIO_N163_REG_FREQ_HI - $08
    DBYTE FAMISTUDIO_N163_REG_FREQ_HI - $10
    DBYTE FAMISTUDIO_N163_REG_FREQ_HI - $18
    DBYTE FAMISTUDIO_N163_REG_FREQ_HI - $20
    DBYTE FAMISTUDIO_N163_REG_FREQ_HI - $28
    DBYTE FAMISTUDIO_N163_REG_FREQ_HI - $30
    DBYTE FAMISTUDIO_N163_REG_FREQ_HI - $38
famistudio_n163_vol_table:
    DBYTE FAMISTUDIO_N163_REG_VOLUME - $00
    DBYTE FAMISTUDIO_N163_REG_VOLUME - $08
    DBYTE FAMISTUDIO_N163_REG_VOLUME - $10
    DBYTE FAMISTUDIO_N163_REG_VOLUME - $18
    DBYTE FAMISTUDIO_N163_REG_VOLUME - $20
    DBYTE FAMISTUDIO_N163_REG_VOLUME - $28
    DBYTE FAMISTUDIO_N163_REG_VOLUME - $30
    DBYTE FAMISTUDIO_N163_REG_VOLUME - $38    
famistudio_n163_env_table:
    DBYTE FAMISTUDIO_N163_CH0_ENVS
    DBYTE FAMISTUDIO_N163_CH1_ENVS
    DBYTE FAMISTUDIO_N163_CH2_ENVS
    DBYTE FAMISTUDIO_N163_CH3_ENVS
    DBYTE FAMISTUDIO_N163_CH4_ENVS
    DBYTE FAMISTUDIO_N163_CH5_ENVS
    DBYTE FAMISTUDIO_N163_CH6_ENVS
    DBYTE FAMISTUDIO_N163_CH7_ENVS
    .if FAMISTUDIO_USE_PHASE_RESET
famistudio_n163_phase_table_lo:
    DBYTE FAMISTUDIO_N163_REG_PHASE_LO - $00
    DBYTE FAMISTUDIO_N163_REG_PHASE_LO - $08
    DBYTE FAMISTUDIO_N163_REG_PHASE_LO - $10
    DBYTE FAMISTUDIO_N163_REG_PHASE_LO - $18
    DBYTE FAMISTUDIO_N163_REG_PHASE_LO - $20
    DBYTE FAMISTUDIO_N163_REG_PHASE_LO - $28
    DBYTE FAMISTUDIO_N163_REG_PHASE_LO - $30
    DBYTE FAMISTUDIO_N163_REG_PHASE_LO - $38
famistudio_n163_phase_table_mid:
    DBYTE FAMISTUDIO_N163_REG_PHASE_MID - $00
    DBYTE FAMISTUDIO_N163_REG_PHASE_MID - $08
    DBYTE FAMISTUDIO_N163_REG_PHASE_MID - $10
    DBYTE FAMISTUDIO_N163_REG_PHASE_MID - $18
    DBYTE FAMISTUDIO_N163_REG_PHASE_MID - $20
    DBYTE FAMISTUDIO_N163_REG_PHASE_MID - $28
    DBYTE FAMISTUDIO_N163_REG_PHASE_MID - $30
    DBYTE FAMISTUDIO_N163_REG_PHASE_MID - $38
famistudio_n163_phase_table_hi:
    DBYTE FAMISTUDIO_N163_REG_PHASE_HI - $00
    DBYTE FAMISTUDIO_N163_REG_PHASE_HI - $08
    DBYTE FAMISTUDIO_N163_REG_PHASE_HI - $10
    DBYTE FAMISTUDIO_N163_REG_PHASE_HI - $18
    DBYTE FAMISTUDIO_N163_REG_PHASE_HI - $20
    DBYTE FAMISTUDIO_N163_REG_PHASE_HI - $28
    DBYTE FAMISTUDIO_N163_REG_PHASE_HI - $30
    DBYTE FAMISTUDIO_N163_REG_PHASE_HI - $38
    .endif
...
famistudio_s5b_reg_table_lo:
    DBYTE FAMISTUDIO_S5B_REG_LO_A, FAMISTUDIO_S5B_REG_LO_B, FAMISTUDIO_S5B_REG_LO_C
famistudio_s5b_reg_table_hi:
    DBYTE FAMISTUDIO_S5B_REG_HI_A, FAMISTUDIO_S5B_REG_HI_B, FAMISTUDIO_S5B_REG_HI_C
famistudio_s5b_vol_table:
    DBYTE FAMISTUDIO_S5B_REG_VOL_A, FAMISTUDIO_S5B_REG_VOL_B, FAMISTUDIO_S5B_REG_VOL_C
famistudio_s5b_env_table:
    DBYTE FAMISTUDIO_S5B_CH0_ENVS, FAMISTUDIO_S5B_CH1_ENVS, FAMISTUDIO_S5B_CH2_ENVS
...
MACRO_START conditional_phase_reset_regular prev_hi, reg_hi 
    DLOCAL @done
    lsr
    bcc @done
    ldy prev_hi
...
MACRO_START conditional_phase_reset_vrc6 prev_hi, reg_hi 
    DLOCAL @done
    lsr
    bcc @done
    tax
...
MACRO_START conditional_phase_reset_fds prev_hi, reg_hi 
    DLOCAL @done
    lsr
    bcc @done
    lda prev_hi
...
;     if step != 0
;         volume += step
;         if step > 0 DAND volume >= target || step < 0 DAND volume <= target
;             volume = target
;             step = 0
...
.else ; !FAMISTUDIO_ASSEMBLER_CA65
...
MACRO_START skip_exp_basic_envelopes
    .if FAMISTUDIO_USE_INSTRUMENT_EXTENDED_RANGE
    ldy #6
.else
    iny
...
famistudio_n163_wave_table:
    DBYTE FAMISTUDIO_N163_REG_WAVE - $00
    DBYTE FAMISTUDIO_N163_REG_WAVE - $08
    DBYTE FAMISTUDIO_N163_REG_WAVE - $10
    DBYTE FAMISTUDIO_N163_REG_WAVE - $18
    DBYTE FAMISTUDIO_N163_REG_WAVE - $20
    DBYTE FAMISTUDIO_N163_REG_WAVE - $28
    DBYTE FAMISTUDIO_N163_REG_WAVE - $30
    DBYTE FAMISTUDIO_N163_REG_WAVE - $38
...
@famistudio_opcode_jmp_lo:
    DBYTE <@opcode_extended_note                ; $40
    DBYTE <@opcode_set_reference                ; $41
    DBYTE <@opcode_loop                         ; $42
    DBYTE <@opcode_disable_attack               ; $43
    DBYTE <@opcode_end_song                     ; $44
    .if FAMISTUDIO_USE_RELEASE_NOTES    
    DBYTE <@opcode_release_note                 ; $45
.else
    DBYTE <@opcode_invalid                      ; $45
    .endif
    .if FAMISTUDIO_USE_FAMITRACKER_TEMPO    
    DBYTE <@opcode_famitracker_speed            ; $46
.else
    DBYTE <@opcode_invalid                      ; $46
    .endif
    .if FAMISTUDIO_USE_FAMITRACKER_DELAYED_NOTES_OR_CUTS
    DBYTE <@opcode_note_delay                   ; $47
    DBYTE <@opcode_cut_delay                    ; $48
.elseif !FAMISTUDIO_USE_FAMITRACKER_TEMPO
    DBYTE <@opcode_set_tempo_envelope           ; $47
    DBYTE <@opcode_reset_tempo_envelope         ; $48
.else
    DBYTE <@opcode_invalid                      ; $47
    DBYTE <@opcode_invalid                      ; $48
    .endif    
    .if FAMISTUDIO_USE_VIBRATO    
    DBYTE <@opcode_override_pitch_envelope      ; $49
    DBYTE <@opcode_clear_pitch_override_flag    ; $4a
.else
    DBYTE <@opcode_invalid                      ; $49
    DBYTE <@opcode_invalid                      ; $4a
    .endif   
    .if FAMISTUDIO_USE_ARPEGGIO
    DBYTE <@opcode_override_arpeggio_envelope   ; $4b
    DBYTE <@opcode_clear_arpeggio_override_flag ; $4c
    DBYTE <@opcode_reset_arpeggio               ; $4d
.else
    DBYTE <@opcode_invalid                      ; $4b
    DBYTE <@opcode_invalid                      ; $4c
    DBYTE <@opcode_invalid                      ; $4d
    .endif    
    .if FAMISTUDIO_USE_PITCH_TRACK
    DBYTE <@opcode_fine_pitch                   ; $4e
.else
    DBYTE <@opcode_invalid                      ; $4e
    .endif    
    .if FAMISTUDIO_USE_DUTYCYCLE_EFFECT
    DBYTE <@opcode_duty_cycle_effect            ; $4f
.else
    DBYTE <@opcode_invalid                      ; $4f
    .endif    
    .if FAMISTUDIO_USE_SLIDE_NOTES
    DBYTE <@opcode_slide                        ; $50
.else
    DBYTE <@opcode_invalid                      ; $50
    .endif    
    .if FAMISTUDIO_USE_VOLUME_SLIDES
    DBYTE <@opcode_volume_slide                 ; $51
.else
    DBYTE <@opcode_invalid                      ; $51
    .endif
    .if FAMISTUDIO_USE_DELTA_COUNTER
    DBYTE <@opcode_dmc_counter                  ; $52
.else
    DBYTE <@opcode_invalid                      ; $52
    .endif
    .if FAMISTUDIO_USE_PHASE_RESET
    DBYTE <@opcode_phase_reset                  ; $53
.else
    DBYTE <@opcode_invalid                      ; $53
    .endif
    .if FAMISTUDIO_USE_INSTRUMENT_EXTENDED_RANGE
    DBYTE <@opcode_extended_instrument          ; $54
.else
    DBYTE <@opcode_invalid                      ; $54
    .endif
    .if !FAMISTUDIO_EXP_NONE                        ; Begin expansion-specific opcodes
    .if FAMISTUDIO_EXP_VRC6
    DBYTE <@opcode_vrc6_saw_volume              ; $55
.else
    DBYTE <@opcode_invalid                      ; $55
    .endif
    .if FAMISTUDIO_EXP_VRC7 DAND FAMISTUDIO_USE_RELEASE_NOTES
    DBYTE <@opcode_vrc7_release_note            ; $56
.else
    DBYTE <@opcode_invalid                      ; $56
    .endif
    .if FAMISTUDIO_EXP_FDS
    DBYTE <@opcode_fds_mod_speed                ; $57
    DBYTE <@opcode_fds_mod_depth                ; $58
.else
    DBYTE <@opcode_invalid                      ; $57
    DBYTE <@opcode_invalid                      ; $58
    .endif
    .if FAMISTUDIO_EXP_FDS DAND FAMISTUDIO_USE_RELEASE_NOTES
    DBYTE <@opcode_fds_release_note             ; $59
.else
    DBYTE <@opcode_invalid                      ; $59
    .endif
    .if FAMISTUDIO_EXP_N163 DAND FAMISTUDIO_USE_RELEASE_NOTES
    DBYTE <@opcode_n163_release_note            ; $5a
.else
    DBYTE <@opcode_invalid                      ; $5a
    .endif
    .if FAMISTUDIO_EXP_N163 DAND FAMISTUDIO_USE_PHASE_RESET
    DBYTE <@opcode_n163_phase_reset             ; $5b
.else
    DBYTE <@opcode_invalid                      ; $5b
    .endif
    .if FAMISTUDIO_EXP_EPSM DAND FAMISTUDIO_USE_RELEASE_NOTES
    DBYTE <@opcode_epsm_release_note            ; $5c
.else
    DBYTE <@opcode_invalid                      ; $5c
    .endif
    .if FAMISTUDIO_EXP_S5B
    DBYTE <@opcode_s5b_manual_env_period        ; $5d
.else
    DBYTE <@opcode_invalid                      ; $5d
    .endif
    .endif
...
famistudio_note_table_lsb:
    .if FAMISTUDIO_CFG_PAL_SUPPORT
        DBYTE $00
        DBYTE $68, $b6, $0e, $6f, $d9, $4b, $c6, $48, $d1, $60, $f6, $92 ; Octave 0
        DBYTE $34, $db, $86, $37, $ec, $a5, $62, $23, $e8, $b0, $7b, $49 ; Octave 1
        DBYTE $19, $ed, $c3, $9b, $75, $52, $31, $11, $f3, $d7, $bd, $a4 ; Octave 2
        DBYTE $8c, $76, $61, $4d, $3a, $29, $18, $08, $f9, $eb, $de, $d1 ; Octave 3
        DBYTE $c6, $ba, $b0, $a6, $9d, $94, $8b, $84, $7c, $75, $6e, $68 ; Octave 4
        DBYTE $62, $5d, $57, $52, $4e, $49, $45, $41, $3e, $3a, $37, $34 ; Octave 5
        DBYTE $31, $2e, $2b, $29, $26, $24, $22, $20, $1e, $1d, $1b, $19 ; Octave 6
        DBYTE $18, $16, $15, $14, $13, $12, $11, $10, $0f, $0e, $0d, $0c ; Octave 7
    .endif
    .if FAMISTUDIO_CFG_NTSC_SUPPORT
        DBYTE $00
        DBYTE $5b, $9c, $e6, $3b, $9a, $01, $72, $ea, $6a, $f1, $7f, $13 ; Octave 0
        DBYTE $ad, $4d, $f3, $9d, $4c, $00, $b8, $74, $34, $f8, $bf, $89 ; Octave 1
        DBYTE $56, $26, $f9, $ce, $a6, $80, $5c, $3a, $1a, $fb, $df, $c4 ; Octave 2
        DBYTE $ab, $93, $7c, $67, $52, $3f, $2d, $1c, $0c, $fd, $ef, $e1 ; Octave 3
        DBYTE $d5, $c9, $bd, $b3, $a9, $9f, $96, $8e, $86, $7e, $77, $70 ; Octave 4
        DBYTE $6a, $64, $5e, $59, $54, $4f, $4b, $46, $42, $3f, $3b, $38 ; Octave 5
        DBYTE $34, $31, $2f, $2c, $29, $27, $25, $23, $21, $1f, $1d, $1b ; Octave 6
        DBYTE $1a, $18, $17, $15, $14, $13, $12, $11, $10, $0f, $0e, $0d ; Octave 7
    .endif
...
famistudio_note_table_msb:
    .if FAMISTUDIO_CFG_PAL_SUPPORT
        DBYTE $00
        DBYTE $0c, $0b, $0b, $0a, $09, $09, $08, $08, $07, $07, $06, $06 ; Octave 0
        DBYTE $06, $05, $05, $05, $04, $04, $04, $04, $03, $03, $03, $03 ; Octave 1
        DBYTE $03, $02, $02, $02, $02, $02, $02, $02, $01, $01, $01, $01 ; Octave 2
        DBYTE $01, $01, $01, $01, $01, $01, $01, $01, $00, $00, $00, $00 ; Octave 3
        DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 4
        DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 5
        DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 6
        DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 7
    .endif
    .if FAMISTUDIO_CFG_NTSC_SUPPORT
        DBYTE $00
        DBYTE $0d, $0c, $0b, $0b, $0a, $0a, $09, $08, $08, $07, $07, $07 ; Octave 0
        DBYTE $06, $06, $05, $05, $05, $05, $04, $04, $04, $03, $03, $03 ; Octave 1
        DBYTE $03, $03, $02, $02, $02, $02, $02, $02, $02, $01, $01, $01 ; Octave 2
        DBYTE $01, $01, $01, $01, $01, $01, $01, $01, $01, $00, $00, $00 ; Octave 3
        DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 4
        DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 5
        DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 6
        DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 7
...
famistudio_saw_note_table_lsb:
    DBYTE $00
    DBYTE $44, $69, $9a, $d6, $1e, $70, $cb, $30, $9e, $13, $91, $16 ; Octave 0
    DBYTE $a2, $34, $cc, $6b, $0e, $b7, $65, $18, $ce, $89, $48, $0a ; Octave 1
    DBYTE $d0, $99, $66, $35, $07, $db, $b2, $8b, $67, $44, $23, $05 ; Octave 2
    DBYTE $e8, $cc, $b2, $9a, $83, $6d, $59, $45, $33, $22, $11, $02 ; Octave 3
    DBYTE $f3, $e6, $d9, $cc, $c1, $b6, $ac, $a2, $99, $90, $88, $80 ; Octave 4
    DBYTE $79, $72, $6c, $66, $60, $5b, $55, $51, $4c, $48, $44, $40 ; Octave 5
    DBYTE $3c, $39, $35, $32, $2f, $2d, $2a, $28, $25, $23, $21, $1f ; Octave 6
    DBYTE $1e, $1c, $1a, $19, $17, $16, $15, $13, $12, $11, $10, $0f ; Octave 7
famistudio_exp_note_table_msb:
famistudio_saw_note_table_msb:    
    DBYTE $00
    DBYTE $0f, $0e, $0d, $0c, $0c, $0b, $0a, $0a, $09, $09, $08, $08 ; Octave 0
    DBYTE $07, $07, $06, $06, $06, $05, $05, $05, $04, $04, $04, $04 ; Octave 1
    DBYTE $03, $03, $03, $03, $03, $02, $02, $02, $02, $02, $02, $02 ; Octave 2
    DBYTE $01, $01, $01, $01, $01, $01, $01, $01, $01, $01, $01, $01 ; Octave 3
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 4
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 5
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 6
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 7
...
famistudio_vrc7_note_table_lsb:
    DBYTE $00
    DBYTE $ac, $b7, $c2, $cd, $d9, $e6, $f4, $02, $12, $22, $33, $46 ; Octave 0
    DBYTE $58, $6e, $84, $9a, $b2, $cc, $e8, $04, $24, $44, $66, $8c ; Octave 1
    DBYTE $b0, $dc, $08, $34, $64, $98, $d0, $08, $48, $88, $cc, $18 ; Octave 2
    DBYTE $60, $b8, $10, $68, $c8, $30, $a0, $10, $90, $10, $98, $30 ; Octave 3
    DBYTE $c0, $70, $20, $d0, $90, $60, $40, $20, $20, $20, $30, $60 ; Octave 4
    DBYTE $80, $e0, $40, $a0, $20, $c0, $80, $40, $40, $40, $60, $c0 ; Octave 5
    DBYTE $00, $c0, $80, $40, $40, $80, $00, $80, $80, $80, $c0, $80 ; Octave 6
    DBYTE $00, $80, $00, $80, $80, $00, $00, $00, $00, $00, $80, $00 ; Octave 7
famistudio_exp_note_table_msb:
famistudio_vrc7_note_table_msb:
    DBYTE $00
    DBYTE $00, $00, $00, $00, $00, $00, $00, $01, $01, $01, $01, $01 ; Octave 0
    DBYTE $01, $01, $01, $01, $01, $01, $01, $02, $02, $02, $02, $02 ; Octave 1
    DBYTE $02, $02, $03, $03, $03, $03, $03, $04, $04, $04, $04, $05 ; Octave 2
    DBYTE $05, $05, $06, $06, $06, $07, $07, $08, $08, $09, $09, $0a ; Octave 3
    DBYTE $0a, $0b, $0c, $0c, $0d, $0e, $0f, $10, $11, $12, $13, $14 ; Octave 4
    DBYTE $15, $16, $18, $19, $1b, $1c, $1e, $20, $22, $24, $26, $28 ; Octave 5
    DBYTE $2b, $2d, $30, $33, $36, $39, $3d, $40, $44, $48, $4c, $51 ; Octave 6
    DBYTE $56, $5b, $61, $66, $6c, $73, $7a, $81, $89, $91, $99, $a3 ; Octave 7    
    .endif

    .if FAMISTUDIO_EXP_EPSM
famistudio_epsm_note_table_lsb:
    DBYTE $00
    DBYTE $9a, $a3, $ad, $b7, $c2, $cd, $da, $e7, $f4, $03, $12, $23 ; Octave 0
    DBYTE $34, $46, $5a, $6e, $84, $9a, $b4, $ce, $e8, $06, $24, $46 ; Octave 1
    DBYTE $68, $8c, $b4, $dc, $08, $34, $68, $9c, $d0, $0c, $48, $8c ; Octave 2
    DBYTE $d0, $18, $68, $b8, $10, $68, $d0, $38, $a0, $18, $90, $18 ; Octave 3
    DBYTE $a0, $30, $d0, $70, $20, $d0, $a0, $70, $40, $30, $20, $30 ; Octave 4
    DBYTE $40, $60, $a0, $e0, $40, $a0, $40, $e0, $80, $60, $40, $60 ; Octave 5
    DBYTE $80, $c0, $40, $c0, $80, $40, $80, $c0, $00, $c0, $80, $c0 ; Octave 6
    DBYTE $00, $80, $80, $80, $00, $80, $00, $80, $00, $80, $00, $80 ; Octave 7
famistudio_epsm_note_table_msb:
    DBYTE $00
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $01, $01, $01 ; Octave 0
    DBYTE $01, $01, $01, $01, $01, $01, $01, $01, $01, $02, $02, $02 ; Octave 1
    DBYTE $02, $02, $02, $02, $03, $03, $03, $03, $03, $04, $04, $04 ; Octave 2
    DBYTE $04, $05, $05, $05, $06, $06, $06, $07, $07, $08, $08, $09 ; Octave 3
    DBYTE $09, $0a, $0a, $0b, $0c, $0c, $0d, $0e, $0f, $10, $11, $12 ; Octave 4
    DBYTE $13, $14, $15, $16, $18, $19, $1b, $1c, $1e, $20, $22, $24 ; Octave 5
    DBYTE $26, $28, $2b, $2d, $30, $33, $36, $39, $3d, $40, $44, $48 ; Octave 6
    DBYTE $4d, $51, $56, $5b, $61, $66, $6d, $73, $7a, $81, $89, $91 ; Octave 7  
famistudio_exp_note_table_lsb:
famistudio_epsm_s_note_table_lsb:
    DBYTE $00
    DBYTE $fa, $4b, $b5, $35, $cb, $75, $32, $02, $e2, $d3, $d2, $e1 ; Octave 0
    DBYTE $fd, $25, $5a, $9a, $e5, $3a, $99, $00, $71, $e9, $69, $f0 ; Octave 1
    DBYTE $7e, $12, $ac, $4c, $f2, $9c, $4c, $00, $b8, $74, $34, $f7 ; Octave 2
    DBYTE $be, $89, $56, $26, $f8, $ce, $a5, $7f, $5b, $39, $19, $fb ; Octave 3
    DBYTE $df, $c4, $aa, $92, $7c, $66, $52, $3f, $2d, $1c, $0c, $fd ; Octave 4
    DBYTE $ef, $e1, $d5, $c9, $bd, $b3, $a9, $9f, $96, $8e, $86, $7e ; Octave 5
    DBYTE $77, $70, $6a, $64, $5e, $59, $54, $4f, $4b, $46, $42, $3f ; Octave 6
    DBYTE $3b, $38, $34, $31, $2f, $2c, $29, $27, $25, $23, $21, $1f ; Octave 7
famistudio_exp_note_table_msb:
famistudio_epsm_s_note_table_msb:
    DBYTE $00
    DBYTE $1d, $1c, $1a, $19, $17, $16, $15, $14, $12, $11, $10, $0f ; Octave 0
    DBYTE $0e, $0e, $0d, $0c, $0b, $0b, $0a, $0a, $09, $08, $08, $07 ; Octave 1
    DBYTE $07, $07, $06, $06, $05, $05, $05, $05, $04, $04, $04, $03 ; Octave 2
    DBYTE $03, $03, $03, $03, $02, $02, $02, $02, $02, $02, $02, $01 ; Octave 3
    DBYTE $01, $01, $01, $01, $01, $01, $01, $01, $01, $01, $01, $00 ; Octave 4
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 5
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 6
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 7
    .endif
...
famistudio_fds_note_table_lsb:
    DBYTE $00
    DBYTE $13, $14, $16, $17, $18, $1a, $1b, $1d, $1e, $20, $22, $24 ; Octave 0
    DBYTE $26, $29, $2b, $2e, $30, $33, $36, $39, $3d, $40, $44, $48 ; Octave 1
    DBYTE $4d, $51, $56, $5b, $61, $66, $6c, $73, $7a, $81, $89, $91 ; Octave 2
    DBYTE $99, $a2, $ac, $b6, $c1, $cd, $d9, $e6, $f3, $02, $11, $21 ; Octave 3
    DBYTE $33, $45, $58, $6d, $82, $99, $b2, $cb, $e7, $04, $22, $43 ; Octave 4
    DBYTE $65, $8a, $b0, $d9, $04, $32, $63, $97, $cd, $07, $44, $85 ; Octave 5
    DBYTE $ca, $13, $60, $b2, $09, $65, $c6, $2d, $9b, $0e, $89, $0b ; Octave 6
    DBYTE $94, $26, $c1, $64, $12, $ca, $8c, $5b, $35, $1d, $12, $16 ; Octave 7
famistudio_exp_note_table_msb:
famistudio_fds_note_table_msb:
    DBYTE $00
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 0
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 1
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00 ; Octave 2
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $01, $01, $01 ; Octave 3
    DBYTE $01, $01, $01, $01, $01, $01, $01, $01, $01, $02, $02, $02 ; Octave 4
    DBYTE $02, $02, $02, $02, $03, $03, $03, $03, $03, $04, $04, $04 ; Octave 5
    DBYTE $04, $05, $05, $05, $06, $06, $06, $07, $07, $08, $08, $09 ; Octave 6
    DBYTE $09, $0a, $0a, $0b, $0c, $0c, $0d, $0e, $0f, $10, $11, $12 ; Octave 7
    .endif
    ...
    famistudio_n163_note_table_lsb:
        DBYTE $00
        DBYTE $47,$4c,$50,$55,$5a,$5f,$65,$6b,$72,$78,$80,$87 ; Octave 0
        DBYTE $8f,$98,$a1,$aa,$b5,$bf,$cb,$d7,$e4,$f1,$00,$0f ; Octave 1
        DBYTE $1f,$30,$42,$55,$6a,$7f,$96,$ae,$c8,$e3,$00,$1e ; Octave 2
        DBYTE $3e,$60,$85,$ab,$d4,$ff,$2c,$5d,$90,$c6,$00,$3d ; Octave 3
        DBYTE $7d,$c1,$0a,$57,$a8,$fe,$59,$ba,$20,$8d,$00,$7a ; Octave 4
        DBYTE $fb,$83,$14,$ae,$50,$fd,$b3,$74,$41,$1a,$00,$f4 ; Octave 5
        DBYTE $f6,$07,$29,$5c,$a1,$fa,$67,$e9,$83,$35,$01,$e8 ; Octave 6
        DBYTE $ec,$0f,$52,$b8,$43,$f4,$ce,$d3,$06,$6a,$02,$d1 ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        DBYTE $00
        DBYTE $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$00 ; Octave 0
        DBYTE $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$01,$01 ; Octave 1
        DBYTE $01,$01,$01,$01,$01,$01,$01,$01,$01,$01,$02,$02 ; Octave 2
        DBYTE $02,$02,$02,$02,$02,$02,$03,$03,$03,$03,$04,$04 ; Octave 3
        DBYTE $04,$04,$05,$05,$05,$05,$06,$06,$07,$07,$08,$08 ; Octave 4
        DBYTE $08,$09,$0a,$0a,$0b,$0b,$0c,$0d,$0e,$0f,$10,$10 ; Octave 5
        DBYTE $11,$13,$14,$15,$16,$17,$19,$1a,$1c,$1e,$20,$21 ; Octave 6
        DBYTE $23,$26,$28,$2a,$2d,$2f,$32,$35,$39,$3c,$40,$43 ; Octave 7
    .endif
    .if FAMISTUDIO_EXP_N163_CHN_CNT = 2
    famistudio_exp_note_table_lsb:
    famistudio_n163_note_table_lsb:
        DBYTE $00
        DBYTE $8f,$98,$a1,$aa,$b5,$bf,$cb,$d7,$e4,$f1,$00,$0f ; Octave 0
        DBYTE $1f,$30,$42,$55,$6a,$7f,$96,$ae,$c8,$e3,$00,$1e ; Octave 1
        DBYTE $3e,$60,$85,$ab,$d4,$ff,$2c,$5d,$90,$c6,$00,$3d ; Octave 2
        DBYTE $7d,$c1,$0a,$57,$a8,$fe,$59,$ba,$20,$8d,$00,$7a ; Octave 3
        DBYTE $fb,$83,$14,$ae,$50,$fd,$b3,$74,$41,$1a,$00,$f4 ; Octave 4
        DBYTE $f6,$07,$29,$5c,$a1,$fa,$67,$e9,$83,$35,$01,$e8 ; Octave 5
        DBYTE $ec,$0f,$52,$b8,$43,$f4,$ce,$d3,$06,$6a,$02,$d1 ; Octave 6
        DBYTE $d9,$1f,$a5,$71,$86,$e8,$9c,$a7,$0d,$d5,$05,$a2 ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        DBYTE $00
        DBYTE $00,$00,$00,$00,$00,$00,$00,$00,$00,$00,$01,$01 ; Octave 0
        DBYTE $01,$01,$01,$01,$01,$01,$01,$01,$01,$01,$02,$02 ; Octave 1
        DBYTE $02,$02,$02,$02,$02,$02,$03,$03,$03,$03,$04,$04 ; Octave 2
        DBYTE $04,$04,$05,$05,$05,$05,$06,$06,$07,$07,$08,$08 ; Octave 3
        DBYTE $08,$09,$0a,$0a,$0b,$0b,$0c,$0d,$0e,$0f,$10,$10 ; Octave 4
        DBYTE $11,$13,$14,$15,$16,$17,$19,$1a,$1c,$1e,$20,$21 ; Octave 5
        DBYTE $23,$26,$28,$2a,$2d,$2f,$32,$35,$39,$3c,$40,$43 ; Octave 6
        DBYTE $47,$4c,$50,$55,$5a,$5f,$65,$6b,$72,$78,$80,$87 ; Octave 7
    .endif
    .if FAMISTUDIO_EXP_N163_CHN_CNT = 3
    famistudio_exp_note_table_lsb:
    famistudio_n163_note_table_lsb:
        DBYTE $00
        DBYTE $d7,$e4,$f1,$00,$0f,$1f,$30,$42,$56,$6a,$80,$96 ; Octave 0
        DBYTE $af,$c8,$e3,$00,$1f,$3f,$61,$85,$ac,$d5,$00,$2d ; Octave 1
        DBYTE $5e,$91,$c7,$01,$3e,$7e,$c3,$0b,$58,$aa,$00,$5b ; Octave 2
        DBYTE $bc,$22,$8f,$02,$7c,$fd,$86,$17,$b1,$54,$00,$b7 ; Octave 3
        DBYTE $78,$45,$1f,$05,$f9,$fb,$0d,$2f,$62,$a8,$01,$6e ; Octave 4
        DBYTE $f1,$8b,$3e,$0a,$f2,$f7,$1a,$5e,$c5,$50,$02,$dc ; Octave 5
        DBYTE $e3,$17,$7c,$15,$e4,$ee,$35,$bd,$8a,$a0,$04,$b9 ; Octave 6
        DBYTE $c6,$2e,$f8,$2a,$c9,$dc,$6a,$7a,$14,$40,$08,$73 ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        DBYTE $00
        DBYTE $00,$00,$00,$01,$01,$01,$01,$01,$01,$01,$01,$01 ; Octave 0
        DBYTE $01,$01,$01,$02,$02,$02,$02,$02,$02,$02,$03,$03 ; Octave 1
        DBYTE $03,$03,$03,$04,$04,$04,$04,$05,$05,$05,$06,$06 ; Octave 2
        DBYTE $06,$07,$07,$08,$08,$08,$09,$0a,$0a,$0b,$0c,$0c ; Octave 3
        DBYTE $0d,$0e,$0f,$10,$10,$11,$13,$14,$15,$16,$18,$19 ; Octave 4
        DBYTE $1a,$1c,$1e,$20,$21,$23,$26,$28,$2a,$2d,$30,$32 ; Octave 5
        DBYTE $35,$39,$3c,$40,$43,$47,$4c,$50,$55,$5a,$60,$65 ; Octave 6
        DBYTE $6b,$72,$78,$80,$87,$8f,$98,$a1,$ab,$b5,$c0,$cb ; Octave 7
    .endif
    .if FAMISTUDIO_EXP_N163_CHN_CNT = 4
    famistudio_exp_note_table_lsb:
    famistudio_n163_note_table_lsb:
        DBYTE $00
        DBYTE $1f,$30,$42,$55,$6a,$7f,$96,$ae,$c8,$e3,$00,$1e ; Octave 0
        DBYTE $3e,$60,$85,$ab,$d4,$ff,$2c,$5d,$90,$c6,$00,$3d ; Octave 1
        DBYTE $7d,$c1,$0a,$57,$a8,$fe,$59,$ba,$20,$8d,$00,$7a ; Octave 2
        DBYTE $fb,$83,$14,$ae,$50,$fd,$b3,$74,$41,$1a,$00,$f4 ; Octave 3
        DBYTE $f6,$07,$29,$5c,$a1,$fa,$67,$e9,$83,$35,$01,$e8 ; Octave 4
        DBYTE $ec,$0f,$52,$b8,$43,$f4,$ce,$d3,$06,$6a,$02,$d1 ; Octave 5
        DBYTE $d9,$1f,$a5,$71,$86,$e8,$9c,$a7,$0d,$d5,$05,$a2 ; Octave 6
        DBYTE $b2,$3e,$4b,$e3,$0c,$d0,$38,$4e,$1b,$ab,$ff,$ff ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        DBYTE $00
        DBYTE $01,$01,$01,$01,$01,$01,$01,$01,$01,$01,$02,$02 ; Octave 0
        DBYTE $02,$02,$02,$02,$02,$02,$03,$03,$03,$03,$04,$04 ; Octave 1
        DBYTE $04,$04,$05,$05,$05,$05,$06,$06,$07,$07,$08,$08 ; Octave 2
        DBYTE $08,$09,$0a,$0a,$0b,$0b,$0c,$0d,$0e,$0f,$10,$10 ; Octave 3
        DBYTE $11,$13,$14,$15,$16,$17,$19,$1a,$1c,$1e,$20,$21 ; Octave 4
        DBYTE $23,$26,$28,$2a,$2d,$2f,$32,$35,$39,$3c,$40,$43 ; Octave 5
        DBYTE $47,$4c,$50,$55,$5a,$5f,$65,$6b,$72,$78,$80,$87 ; Octave 6
        DBYTE $8f,$98,$a1,$aa,$b5,$bf,$cb,$d7,$e4,$f1,$ff,$ff ; Octave 7
    .endif
    .if FAMISTUDIO_EXP_N163_CHN_CNT = 5
    famistudio_exp_note_table_lsb:
    famistudio_n163_note_table_lsb:
        DBYTE $00
        DBYTE $67,$7c,$93,$ab,$c4,$df,$fc,$1a,$3a,$5c,$80,$a6 ; Octave 0
        DBYTE $ce,$f9,$26,$56,$89,$bf,$f8,$34,$74,$b8,$00,$4c ; Octave 1
        DBYTE $9c,$f2,$4c,$ac,$12,$7e,$f0,$69,$e9,$70,$00,$98 ; Octave 2
        DBYTE $39,$e4,$99,$59,$24,$fc,$e0,$d2,$d2,$e1,$00,$31 ; Octave 3
        DBYTE $73,$c9,$33,$b3,$49,$f8,$c0,$a4,$a4,$c2,$01,$62 ; Octave 4
        DBYTE $e7,$93,$67,$67,$93,$f1,$81,$48,$48,$85,$03,$c5 ; Octave 5
        DBYTE $cf,$26,$cf,$ce,$27,$e2,$03,$90,$91,$0b,$06,$8a ; Octave 6
        DBYTE $9f,$4d,$9e,$9c,$4f,$c4,$06,$ff,$ff,$ff,$ff,$ff ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        DBYTE $00
        DBYTE $01,$01,$01,$01,$01,$01,$01,$02,$02,$02,$02,$02 ; Octave 0
        DBYTE $02,$02,$03,$03,$03,$03,$03,$04,$04,$04,$05,$05 ; Octave 1
        DBYTE $05,$05,$06,$06,$07,$07,$07,$08,$08,$09,$0a,$0a ; Octave 2
        DBYTE $0b,$0b,$0c,$0d,$0e,$0e,$0f,$10,$11,$12,$14,$15 ; Octave 3
        DBYTE $16,$17,$19,$1a,$1c,$1d,$1f,$21,$23,$25,$28,$2a ; Octave 4
        DBYTE $2c,$2f,$32,$35,$38,$3b,$3f,$43,$47,$4b,$50,$54 ; Octave 5
        DBYTE $59,$5f,$64,$6a,$71,$77,$7f,$86,$8e,$97,$a0,$a9 ; Octave 6
        DBYTE $b3,$be,$c9,$d5,$e2,$ef,$fe,$ff,$ff,$ff,$ff,$ff ; Octave 7
    .endif
    .if FAMISTUDIO_EXP_N163_CHN_CNT = 6
    famistudio_exp_note_table_lsb:
    famistudio_n163_note_table_lsb:
        DBYTE $00
        DBYTE $af,$c8,$e3,$00,$1f,$3f,$61,$85,$ac,$d5,$00,$2d ; Octave 0
        DBYTE $5e,$91,$c7,$01,$3e,$7e,$c3,$0b,$58,$aa,$00,$5b ; Octave 1
        DBYTE $bc,$22,$8f,$02,$7c,$fd,$86,$17,$b1,$54,$00,$b7 ; Octave 2
        DBYTE $78,$45,$1f,$05,$f9,$fb,$0d,$2f,$62,$a8,$01,$6e ; Octave 3
        DBYTE $f1,$8b,$3e,$0a,$f2,$f7,$1a,$5e,$c5,$50,$02,$dc ; Octave 4
        DBYTE $e3,$17,$7c,$15,$e4,$ee,$35,$bd,$8a,$a0,$04,$b9 ; Octave 5
        DBYTE $c6,$2e,$f8,$2a,$c9,$dc,$6a,$7a,$14,$40,$08,$73 ; Octave 6
        DBYTE $8c,$5d,$f1,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        DBYTE $00
        DBYTE $01,$01,$01,$02,$02,$02,$02,$02,$02,$02,$03,$03 ; Octave 0
        DBYTE $03,$03,$03,$04,$04,$04,$04,$05,$05,$05,$06,$06 ; Octave 1
        DBYTE $06,$07,$07,$08,$08,$08,$09,$0a,$0a,$0b,$0c,$0c ; Octave 2
        DBYTE $0d,$0e,$0f,$10,$10,$11,$13,$14,$15,$16,$18,$19 ; Octave 3
        DBYTE $1a,$1c,$1e,$20,$21,$23,$26,$28,$2a,$2d,$30,$32 ; Octave 4
        DBYTE $35,$39,$3c,$40,$43,$47,$4c,$50,$55,$5a,$60,$65 ; Octave 5
        DBYTE $6b,$72,$78,$80,$87,$8f,$98,$a1,$ab,$b5,$c0,$cb ; Octave 6
        DBYTE $d7,$e4,$f1,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff ; Octave 7
    .endif
    .if FAMISTUDIO_EXP_N163_CHN_CNT = 7
    famistudio_exp_note_table_lsb:
    famistudio_n163_note_table_lsb:
        DBYTE $00
        DBYTE $f6,$14,$34,$56,$79,$9f,$c7,$f1,$1e,$4d,$80,$b5 ; Octave 0
        DBYTE $ed,$29,$69,$ac,$f3,$3e,$8e,$e3,$3c,$9b,$00,$6a ; Octave 1
        DBYTE $db,$53,$d2,$58,$e6,$7d,$1d,$c6,$79,$37,$00,$d5 ; Octave 2
        DBYTE $b7,$a6,$a4,$b0,$cd,$fa,$3a,$8c,$f3,$6e,$01,$ab ; Octave 3
        DBYTE $6f,$4d,$48,$61,$9a,$f5,$74,$19,$e6,$dd,$02,$56 ; Octave 4
        DBYTE $de,$9b,$91,$c3,$35,$eb,$e8,$32,$cc,$bb,$04,$ad ; Octave 5
        DBYTE $bc,$36,$22,$86,$6b,$d6,$d1,$64,$98,$76,$09,$5b ; Octave 6
        DBYTE $79,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        DBYTE $00
        DBYTE $01,$02,$02,$02,$02,$02,$02,$02,$03,$03,$03,$03 ; Octave 0
        DBYTE $03,$04,$04,$04,$04,$05,$05,$05,$06,$06,$07,$07 ; Octave 1
        DBYTE $07,$08,$08,$09,$09,$0a,$0b,$0b,$0c,$0d,$0e,$0e ; Octave 2
        DBYTE $0f,$10,$11,$12,$13,$14,$16,$17,$18,$1a,$1c,$1d ; Octave 3
        DBYTE $1f,$21,$23,$25,$27,$29,$2c,$2f,$31,$34,$38,$3b ; Octave 4
        DBYTE $3e,$42,$46,$4a,$4f,$53,$58,$5e,$63,$69,$70,$76 ; Octave 5
        DBYTE $7d,$85,$8d,$95,$9e,$a7,$b1,$bc,$c7,$d3,$e0,$ed ; Octave 6
        DBYTE $fb,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff ; Octave 7
    .endif
    .if FAMISTUDIO_EXP_N163_CHN_CNT = 8
    famistudio_exp_note_table_lsb:
    famistudio_n163_note_table_lsb:
        DBYTE $00
        DBYTE $3e,$60,$85,$ab,$d4,$ff,$2c,$5d,$90,$c6,$00,$3d ; Octave 0
        DBYTE $7d,$c1,$0a,$57,$a8,$fe,$59,$ba,$20,$8d,$00,$7a ; Octave 1
        DBYTE $fb,$83,$14,$ae,$50,$fd,$b3,$74,$41,$1a,$00,$f4 ; Octave 2
        DBYTE $f6,$07,$29,$5c,$a1,$fa,$67,$e9,$83,$35,$01,$e8 ; Octave 3
        DBYTE $ec,$0f,$52,$b8,$43,$f4,$ce,$d3,$06,$6a,$02,$d1 ; Octave 4
        DBYTE $d9,$1f,$a5,$71,$86,$e8,$9c,$a7,$0d,$d5,$05,$a2 ; Octave 5
        DBYTE $b2,$3e,$4b,$e3,$0c,$d0,$38,$4e,$1b,$ab,$ff,$ff ; Octave 6
        DBYTE $ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff ; Octave 7
    famistudio_exp_note_table_msb:
    famistudio_n163_note_table_msb:
        DBYTE $00
        DBYTE $02,$02,$02,$02,$02,$02,$03,$03,$03,$03,$04,$04 ; Octave 0
        DBYTE $04,$04,$05,$05,$05,$05,$06,$06,$07,$07,$08,$08 ; Octave 1
        DBYTE $08,$09,$0a,$0a,$0b,$0b,$0c,$0d,$0e,$0f,$10,$10 ; Octave 2
        DBYTE $11,$13,$14,$15,$16,$17,$19,$1a,$1c,$1e,$20,$21 ; Octave 3
        DBYTE $23,$26,$28,$2a,$2d,$2f,$32,$35,$39,$3c,$40,$43 ; Octave 4
        DBYTE $47,$4c,$50,$55,$5a,$5f,$65,$6b,$72,$78,$80,$87 ; Octave 5
        DBYTE $8f,$98,$a1,$aa,$b5,$bf,$cb,$d7,$e4,$f1,$ff,$ff ; Octave 6
        DBYTE $ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff,$ff ; Octave 7
    .endif
    .endif
...
famistudio_channel_to_volume_env:
    DBYTE FAMISTUDIO_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_CH2_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_CH3_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE $ff
    .if FAMISTUDIO_EXP_VRC6
    DBYTE FAMISTUDIO_VRC6_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_VRC6_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_VRC6_CH2_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_VRC7
    DBYTE FAMISTUDIO_VRC7_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_VRC7_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_VRC7_CH2_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_VRC7_CH3_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_VRC7_CH4_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_VRC7_CH5_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_FDS
    DBYTE FAMISTUDIO_FDS_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_MMC5
    DBYTE FAMISTUDIO_MMC5_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_MMC5_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_N163
    DBYTE FAMISTUDIO_N163_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_N163_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_N163_CH2_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_N163_CH3_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_N163_CH4_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_N163_CH5_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_N163_CH6_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_N163_CH7_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_S5B
    DBYTE FAMISTUDIO_S5B_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_S5B_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    DBYTE FAMISTUDIO_S5B_CH2_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 0
    DBYTE FAMISTUDIO_EPSM_CH0_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 1
    DBYTE FAMISTUDIO_EPSM_CH1_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 2
    DBYTE FAMISTUDIO_EPSM_CH2_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 3
    DBYTE FAMISTUDIO_EPSM_CH3_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 4
    DBYTE FAMISTUDIO_EPSM_CH4_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 5
    DBYTE FAMISTUDIO_EPSM_CH5_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 6
    DBYTE FAMISTUDIO_EPSM_CH6_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 7
    DBYTE FAMISTUDIO_EPSM_CH7_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 8
    DBYTE FAMISTUDIO_EPSM_CH8_ENVS+FAMISTUDIO_ENV_VOLUME_OFF
    .endif
    .endif
...
famistudio_channel_to_arpeggio_env:
    DBYTE FAMISTUDIO_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_CH2_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_CH3_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE $ff
    .if FAMISTUDIO_EXP_VRC6
    DBYTE FAMISTUDIO_VRC6_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_VRC6_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_VRC6_CH2_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_VRC7
    DBYTE FAMISTUDIO_VRC7_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_VRC7_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_VRC7_CH2_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_VRC7_CH3_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_VRC7_CH4_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_VRC7_CH5_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_FDS
    DBYTE FAMISTUDIO_FDS_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_MMC5
    DBYTE FAMISTUDIO_MMC5_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_MMC5_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_N163
    DBYTE FAMISTUDIO_N163_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_N163_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_N163_CH2_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_N163_CH3_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_N163_CH4_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_N163_CH5_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_N163_CH6_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_N163_CH7_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_S5B
    DBYTE FAMISTUDIO_S5B_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_S5B_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    DBYTE FAMISTUDIO_S5B_CH2_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 0
    DBYTE FAMISTUDIO_EPSM_CH0_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 1
    DBYTE FAMISTUDIO_EPSM_CH1_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 2
    DBYTE FAMISTUDIO_EPSM_CH2_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 3
    DBYTE FAMISTUDIO_EPSM_CH3_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 4
    DBYTE FAMISTUDIO_EPSM_CH4_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 5
    DBYTE FAMISTUDIO_EPSM_CH5_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 6
    DBYTE FAMISTUDIO_EPSM_CH6_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 7
    DBYTE FAMISTUDIO_EPSM_CH7_ENVS+FAMISTUDIO_ENV_NOTE_OFF
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 8
    DBYTE FAMISTUDIO_EPSM_CH8_ENVS+FAMISTUDIO_ENV_NOTE_OFF
...
; This table will only be defined if we use noise slides, otherwise identical to "famistudio_channel_to_pitch_env".
    ...
    DBYTE $01
    DBYTE $02
    DBYTE FAMISTUDIO_NOISE_SLIDE_INDEX ; Keep the noise slide at the end so the pitch envelopes/slides are in sync.
    DBYTE $ff ; no slide for DPCM
    .if FAMISTUDIO_EXP_VRC6
    DBYTE FAMISTUDIO_VRC6_CH0_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_VRC6_CH1_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_VRC6_CH2_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_VRC7
    DBYTE FAMISTUDIO_VRC7_CH0_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_VRC7_CH1_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_VRC7_CH2_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_VRC7_CH3_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_VRC7_CH4_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_VRC7_CH5_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_FDS
    DBYTE FAMISTUDIO_FDS_CH0_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_MMC5    
    DBYTE FAMISTUDIO_MMC5_CH0_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_MMC5_CH1_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_N163    
    DBYTE FAMISTUDIO_N163_CH0_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_N163_CH1_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_N163_CH2_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_N163_CH3_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_N163_CH4_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_N163_CH5_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_N163_CH6_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_N163_CH7_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_S5B    
    DBYTE FAMISTUDIO_S5B_CH0_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_S5B_CH1_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_S5B_CH2_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_EPSM
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 0
    DBYTE FAMISTUDIO_EPSM_CH0_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 1
    DBYTE FAMISTUDIO_EPSM_CH1_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 2
    DBYTE FAMISTUDIO_EPSM_CH2_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 3
    DBYTE FAMISTUDIO_EPSM_CH3_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 4
    DBYTE FAMISTUDIO_EPSM_CH4_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 5
    DBYTE FAMISTUDIO_EPSM_CH5_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 6
    DBYTE FAMISTUDIO_EPSM_CH6_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 7
    DBYTE FAMISTUDIO_EPSM_CH7_PITCH_ENV_IDX
    .endif
    .if FAMISTUDIO_EXP_EPSM_ENV_CNT > 8
    DBYTE FAMISTUDIO_EPSM_CH8_PITCH_ENV_IDX
    .endif ; FAMISTUDIO_EXP_EPSM_ENV_CNT > 8
    .endif ; FAMISTUDIO_EXP_EPSM
...
famistudio_channel_to_pitch_env:
    ...
    DBYTE $01
    DBYTE $02
    DBYTE $ff ; no pitch envelopes for noise
    DBYTE $ff ; no pitch envelopes slide for DPCM
    .if FAMISTUDIO_EXP_VRC6
    DBYTE FAMISTUDIO_VRC6_CH0_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_VRC6_CH1_PITCH_ENV_IDX
    DBYTE FAMISTUDIO_VRC6_CH2_PITCH_ENV_IDX
...
famistudio_channel_to_dutycycle:
    ...
    DBYTE $ff
    .if FAMISTUDIO_EXP_VRC6
    DBYTE FAMISTUDIO_VRC6_CH0_DUTY_IDX
    DBYTE FAMISTUDIO_VRC6_CH1_DUTY_IDX
    DBYTE FAMISTUDIO_VRC6_CH2_DUTY_IDX
    .endif
    .if FAMISTUDIO_EXP_MMC5
    DBYTE FAMISTUDIO_MMC5_CH0_DUTY_IDX
    DBYTE FAMISTUDIO_MMC5_CH1_DUTY_IDX
    .endif

; For a given channel, returns the index of the duty cycle envelope.
famistudio_channel_to_duty_env:
    DBYTE FAMISTUDIO_CH0_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    DBYTE FAMISTUDIO_CH1_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    DBYTE $ff
    DBYTE FAMISTUDIO_CH3_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    DBYTE $ff
    .if FAMISTUDIO_EXP_VRC6
    DBYTE FAMISTUDIO_VRC6_CH0_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    DBYTE FAMISTUDIO_VRC6_CH1_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    DBYTE FAMISTUDIO_VRC6_CH2_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    .endif
    .if FAMISTUDIO_EXP_MMC5
    DBYTE FAMISTUDIO_MMC5_CH0_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    DBYTE FAMISTUDIO_MMC5_CH1_ENVS+FAMISTUDIO_ENV_DUTY_OFF
    .endif
    .endif
...
famistudio_tempo_frame_lookup:
    DBYTE $01, $02 ; NTSC -> NTSC, NTSC -> PAL
    DBYTE $00, $01 ; PAL  -> NTSC, PAL  -> PAL
    .endif
...
famistudio_volume_table:
    DBYTE $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00
    DBYTE $00, $01, $01, $01, $01, $01, $01, $01, $01, $01, $01, $01, $01, $01, $01, $01
    DBYTE $00, $01, $01, $01, $01, $01, $01, $01, $01, $01, $01, $01, $02, $02, $02, $02
    DBYTE $00, $01, $01, $01, $01, $01, $01, $01, $02, $02, $02, $02, $02, $03, $03, $03
    DBYTE $00, $01, $01, $01, $01, $01, $02, $02, $02, $02, $03, $03, $03, $03, $04, $04
    DBYTE $00, $01, $01, $01, $01, $02, $02, $02, $03, $03, $03, $04, $04, $04, $05, $05
    DBYTE $00, $01, $01, $01, $02, $02, $02, $03, $03, $04, $04, $04, $05, $05, $06, $06
    DBYTE $00, $01, $01, $01, $02, $02, $03, $03, $04, $04, $05, $05, $06, $06, $07, $07
    DBYTE $00, $01, $01, $02, $02, $03, $03, $04, $04, $05, $05, $06, $06, $07, $07, $08
    DBYTE $00, $01, $01, $02, $02, $03, $04, $04, $05, $05, $06, $07, $07, $08, $08, $09
    DBYTE $00, $01, $01, $02, $03, $03, $04, $05, $05, $06, $07, $07, $08, $09, $09, $0a
    DBYTE $00, $01, $01, $02, $03, $04, $04, $05, $06, $07, $07, $08, $09, $0a, $0a, $0b
    DBYTE $00, $01, $02, $02, $03, $04, $05, $06, $06, $07, $08, $09, $0a, $0a, $0b, $0c
    DBYTE $00, $01, $02, $03, $03, $04, $05, $06, $07, $08, $09, $0a, $0a, $0b, $0c, $0d
    DBYTE $00, $01, $02, $03, $04, $05, $06, $07, $07, $08, $09, $0a, $0b, $0c, $0d, $0e
    DBYTE $00, $01, $02, $03, $04, $05, $06, $07, $08, $09, $0a, $0b, $0c, $0d, $0e, $0f
...
famistudio_rhythm_lut:
    ...
    DBYTE DLOBYTE(EPSM_CHANNEL1_RHYTHM_OFFSET)
.else
    DBYTE $ff
    .endif
    .if FAMISTUDIO_EXP_EPSM_RHYTHM_CHN2_ENABLE
    DBYTE DLOBYTE(EPSM_CHANNEL2_RHYTHM_OFFSET)
.else
    DBYTE $ff
    .endif
    .if FAMISTUDIO_EXP_EPSM_RHYTHM_CHN3_ENABLE
    DBYTE DLOBYTE(EPSM_CHANNEL3_RHYTHM_OFFSET)
.else
    DBYTE $ff
    .endif
    .if FAMISTUDIO_EXP_EPSM_RHYTHM_CHN4_ENABLE
    DBYTE DLOBYTE(EPSM_CHANNEL4_RHYTHM_OFFSET)
.else
    DBYTE $ff
    .endif
    .if FAMISTUDIO_EXP_EPSM_RHYTHM_CHN5_ENABLE
    DBYTE DLOBYTE(EPSM_CHANNEL5_RHYTHM_OFFSET)
.else
    DBYTE $ff
    .endif
    .if FAMISTUDIO_EXP_EPSM_RHYTHM_CHN6_ENABLE
    DBYTE DLOBYTE(EPSM_CHANNEL6_RHYTHM_OFFSET)
.else
    DBYTE $ff
    .endif
    .endif
...
.undefine DWORD
    ...
    .if FAMISTUDIO_ASSEMBLER_CA65
; Things that are specific to CA65
...
.export famistudio_sfx_sample_play
    .endif ; FAMISTUDIO_CFG_SFX_SUPPORT
...
.exportzp FAMISTUDIO_SFX_CH3
    .endif ; FAMISTUDIO_CFG_DPCM_SUPPORT
    .if FAMISTUDIO_USE_DPCM_BANKSWITCHING
.global famistudio_dpcm_bank_callback
    .endif ; FAMISTUDIO_USE_DPCM_BANKSWITCHING
...
.export _famistudio_sfx_sample_play=famistudio_sfx_sample_play
    ...
    .endif ; FAMISTUDIO_CFG_C_BINDINGS
    .endif ; FAMISTUDIO_CFG_SFX_SUPPORT
