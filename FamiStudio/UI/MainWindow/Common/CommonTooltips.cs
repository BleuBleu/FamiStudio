...
namespace FamiStudio
{
    public static class CommonTooltips
    {
        ...
        public readonly static string NotesPerBar = "Number of notes in a bar. This is purely cosmetic. A thicker line will be drawn between bars in the piano roll.";
