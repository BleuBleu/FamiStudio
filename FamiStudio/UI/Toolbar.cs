...
namespace FamiStudio
{
    class Toolbar : Direct2DUserControl
    {
        ...
        protected override void OnDirect2DInitialized(Direct2DGraphics g)
        {
            ...
            buttons[ButtonNew]      = new Button { X =   4, Y = 4, Bmp = g.ConvertBitmap(Resources.File), Press = OnNew };
            buttons[ButtonOpen]     = new Button { X =  44, Y = 4, Bmp = g.ConvertBitmap(Resources.Open), Press = OnOpen };
            buttons[ButtonSave]     = new Button { X =  84, Y = 4, Bmp = g.ConvertBitmap(Resources.Save), Press = OnSave };
            buttons[ButtonFamitone] = new Button { X = 124, Y = 4, Bmp = g.ConvertBitmap(Resources.ExportMusic), Press = OnExportFamitone, Enabled = OnExportFamitoneEnabled };
            buttons[ButtonUndo]     = new Button { X = 164, Y = 4, Bmp = g.ConvertBitmap(Resources.Undo), Press = OnUndo, Enabled = OnUndoEnabled };
            buttons[ButtonRedo]     = new Button { X = 204, Y = 4, Bmp = g.ConvertBitmap(Resources.Redo), Press = OnRedo, Enabled = OnRedoEnabled };
            buttons[ButtonPlay]     = new Button { X = 436, Y = 4, Press = OnPlay, GetBitmap = OnPlayGetBitmap };
            buttons[ButtonRewind]   = new Button { X = 476, Y = 4, Bmp = g.ConvertBitmap(Resources.Rewind), Press = OnRewind };
            buttons[ButtonLoop]     = new Button { X = 516, Y = 4, Press = OnLoop, GetBitmap = OnLoopGetBitmap };
