...
namespace FamiStudio
{
    ...
    public partial class PropertyPage : UserControl
    {
        ...
        public PropertyPage()
        {
            ...
            try
            {
                font = new Font(Theme.PrivateFontCollection.Families[0], 10.0f, FontStyle.Regular);
            }
            catch
            {
            }
        ...
        private Label CreateLabel(string str)
        {
            ...
            label.Font = font;
            label.AutoSize = true;
            label.ForeColor = Direct2DGraphics.ToDrawingColor4(Theme.LightGreyFillColor2);
        ...
        public void SetPropertyValue(int idx, object val)
        {

        }

        public void SetPropertyValue<T>(int idx, T val)
        {
            SetPropertyValue(idx, (T)val);
        }
