...
namespace FamiStudio
{
    public class Note
    {
        ...
        public void SerializeState(ProjectBuffer buffer)
        {
            ...
            if (buffer.Version >= 12 && (EffectMask & EffectDeltaCounterMask)   == EffectDeltaCounterMask)   buffer.Serialize(ref dmcCounter);
        ...
        public static int GetEffectMaxValue(Song song, Channel channel, int fx)
        {
            switch (fx)
            {
                ...
                case EffectDutyCycle    : return channel.Expansion == ExpansionType.Vrc6 ? 7 : 3;
        ...
        public static int GetEffectDefaultValue(Song song, int fx)
        {
            switch (fx)
            {
                ...
                case EffectDeltaCounter : return NesApu.DACDefaultValue;
            }
