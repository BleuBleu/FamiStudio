            ...
            switch (format)
            {
                case ExportFormat.WavMp3:
                    ...
                    page.AddGrid(ChannelsLabel, new[] { 
                        ...
                        new ColumnDesc(PanColumn, 0.6f, 0, 100, 50, (o) => FormattableString.Invariant($"{(int)o} %")) 
                ...
                case ExportFormat.Video:
                    if (Platform.CanExportToVideo)
                    {
                        ...
                        page.AddGrid(ChannelsLabel, new[] {
                            ...
                            new ColumnDesc(PanColumn, 0.2f, 0, 100, 50, (o) => FormattableString.Invariant($"{(int)o} %")),
                            new ColumnDesc(TransposeColumn, 0.2f, -8, 8, 0),
