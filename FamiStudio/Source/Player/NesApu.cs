...
namespace FamiStudio
{
    public static class NesApu
    {
        ...
        // Adapted from FamiTracker 
        public static readonly ushort[] NoteTableN163 = new ushort[]
        {
            0x0000,
            0x011f, 0x0130, 0x0142, 0x0155, 0x016a, 0x017f, 0x0196, 0x01ae, 0x01c8, 0x01e3, 0x0200, 0x021e,  // Octave 0
            0x023e, 0x0260, 0x0285, 0x02ab, 0x02d4, 0x02ff, 0x032c, 0x035d, 0x0390, 0x03c6, 0x0400, 0x043d,  // Octave 1
            0x047d, 0x04c1, 0x050a, 0x0557, 0x05a8, 0x05fe, 0x0659, 0x06ba, 0x0720, 0x078d, 0x0800, 0x087a,  // Octave 2
            0x08fb, 0x0983, 0x0a14, 0x0aae, 0x0b50, 0x0bfd, 0x0cb3, 0x0d74, 0x0e41, 0x0f1a, 0x1000, 0x10f4,  // Octave 3
            0x11f6, 0x1307, 0x1429, 0x155c, 0x16a1, 0x17fa, 0x1967, 0x1ae9, 0x1c83, 0x1e35, 0x2001, 0x21e8,  // Octave 4
            0x23ec, 0x260f, 0x2852, 0x2ab8, 0x2d43, 0x2ff4, 0x32ce, 0x35d3, 0x3906, 0x3c6a, 0x4002, 0x43d1,  // Octave 5
            0x47d8, 0x4c1e, 0x50a4, 0x5570, 0x5a86, 0x5fe8, 0x659c, 0x6ba6, 0x720c, 0x78d4, 0x8004, 0x87a2,  // Octave 6
            0x8fb0, 0x983c, 0xa148, 0xaae0, 0xb50c, 0xbfd0, 0xcb38, 0xd74c, 0xe418, 0xf1a8, 0xffff, 0xffff   // Octave 7
        };

        // Based off FamiTracker, but handled differently.
        public static readonly ushort[] NoteTableVrc7 = new ushort[]
        {
            0x0000,
            0x00ac, 0x00b7, 0x00c2, 0x00cd, 0x00d9, 0x00e6, 0x00f4, 0x0102, 0x0112, 0x0122, 0x0133, 0x0146,  // Octave 0
            0x0158, 0x016e, 0x0184, 0x019a, 0x01b2, 0x01cc, 0x01e8, 0x0204, 0x0224, 0x0244, 0x0266, 0x028c,  // Octave 1
            0x02b0, 0x02dc, 0x0308, 0x0334, 0x0364, 0x0398, 0x03d0, 0x0408, 0x0448, 0x0488, 0x04cc, 0x0518,  // Octave 2
            0x0560, 0x05b8, 0x0610, 0x0668, 0x06c8, 0x0730, 0x07a0, 0x0810, 0x0890, 0x0910, 0x0998, 0x0a30,  // Octave 3
            0x0ac0, 0x0b70, 0x0c20, 0x0cd0, 0x0d90, 0x0e60, 0x0f40, 0x1020, 0x1120, 0x1220, 0x1330, 0x1460,  // Octave 4
            0x1580, 0x16e0, 0x1840, 0x19a0, 0x1b20, 0x1cc0, 0x1e80, 0x2040, 0x2240, 0x2440, 0x2660, 0x28c0,  // Octave 5
            0x2b00, 0x2dc0, 0x3080, 0x3340, 0x3640, 0x3980, 0x3d00, 0x4080, 0x4480, 0x4880, 0x4cc0, 0x5180,  // Octave 6
            0x5600, 0x5b80, 0x6100, 0x6680, 0x6c80, 0x7300, 0x7a00, 0x8100, 0x8900, 0x9100, 0x9980, 0xa300,  // Octave 7
        };
