...
namespace FamiStudio
{
    public static class NesApu
    {
        ...
        public extern static int Init(int apuIdx, int sampleRate, int pal, int seperateTnd, int expansion, bool stereo, [MarshalAs(UnmanagedType.FunctionPtr)] DmcReadDelegate dmcCallback);
