    ...
    public class DPCMChannelState : ChannelState
    {
        ...
        public override void UpdateAPU()
        {
            ...
            else if (newNote && note.IsValid)
            {
                ...
                var mapping = FamiStudioForm.StaticProject.SamplesMapping[note.Value];
                if (mapping != null && mapping.Sample != null)
                {
                    WriteApuRegister(NesApu.APU_DMC_START, FamiStudioForm.StaticProject.GetAddressForSample(mapping.Sample) >> 6);
