...
namespace FamiStudio
{
    ...
    public class S5BRegisterViewer : YMRegisterViewer
    {
        ...
        public S5BRegisterViewer(NesApu.NesRegisterValues r) : base(ExpansionType.S5B)
        {
            ...
            RegisterRows = new[]
            {
                new RegisterViewerRow("$00", 0xF000, 0x00, 0x01),
                new RegisterViewerRow("$02", 0xF000, 0x02, 0x03),
                new RegisterViewerRow("$04", 0xF000, 0x04, 0x05),
                new RegisterViewerRow("$06", 0xF000, 0x06, 0x07),
                new RegisterViewerRow("$08", 0xF000, 0x08, 0x0a),
                new RegisterViewerRow("$0B", 0xF000, 0x0B, 0x0D),
            };
            InterpeterRows = new RegisterViewerRow[5][];
            for (int j = 0; j < 3; j++)
            {
