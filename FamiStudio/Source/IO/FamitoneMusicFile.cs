        ...
        private int OutputHeader(bool separateSongs)
        {
            ...
            switch (project.ExpansionAudio)
            {
                case Project.ExpansionFds:
                    lines.Add($"\t{dw} {ll}instruments_fds");  size += 2;
                    break;
                case Project.ExpansionN163:
                    lines.Add($"\t{dw} {ll}instruments_n163"); size += 2;
                    break;
                case Project.ExpansionVrc7:
                    lines.Add($"\t{dw} {ll}instruments_vrc7"); size += 2;
                    break;
            }
        ...
        private void OutputInstruments()
        {
            ...
            foreach (var instrument in project.Instruments)
            {
                for (int i = 0; i < Envelope.Count; i++)
                {
                    ...
                    if (i >= Envelope.RegularCount)
                    {
                        if (i == Envelope.FdsModulation)
            ...
            // Write FDS Instruments
            if (project.ExpansionAudio == Project.ExpansionFds)
            {
                lines.Add($"{ll}instruments_fds:");
