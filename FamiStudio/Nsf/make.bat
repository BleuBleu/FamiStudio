...
CALL :CompileNsfPermutation nsf_template.cfg, "{CODESIZE}=$c80 {SONGDATASTART}=$8d00", "-D FAMISTUDIO -D FT_NTSC_SUPPORT=1 -D FT_N163 -D FT_N163_CHN_CNT=2 -D FT_FAMISTUDIO_TEMPO=1", nsf_famistudio_n163_2ch_ntsc_tempo
CALL :CompileNsfPermutation nsf_template.cfg, "{CODESIZE}=$c80 {SONGDATASTART}=$8d00", "-D FAMISTUDIO -D FT_NTSC_SUPPORT=1 -D FT_N163 -D FT_N163_CHN_CNT=3 -D FT_FAMISTUDIO_TEMPO=1", nsf_famistudio_n163_3ch_ntsc_tempo
