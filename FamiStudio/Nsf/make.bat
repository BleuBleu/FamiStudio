...
CALL :CompileNsfPermutation nsf_template.cfg, "{CODESIZE}=$b80 {SONGDATASTART}=$8c00", "-D FAMISTUDIO -D FT_NTSC_SUPPORT=1 -D FT_VRC6", nsf_famistudio_vrc6_ntsc
...
CALL :CompileNsfPermutation nsf_template.cfg, "{CODESIZE}=$a80 {SONGDATASTART}=$8b00", "-D FAMISTUDIO -D FT_NTSC_SUPPORT=1 -D FT_MMC5 -D FT_FAMISTUDIO_TEMPO=1", nsf_famistudio_mmc5_ntsc_tempo
