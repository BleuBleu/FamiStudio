...
..\bin\Release\net7.0\FamiStudio.exe TestMulti.nsf famistudio-txt-export TestMulti_NsfTest.txt -nsf-import-pattern-length:160 -nsf-import-duration:248 -famistudio-txt-bare
..\bin\Release\net7.0\FamiStudio.exe TestMultiEPSM.nsf famistudio-txt-export TestMultiEPSM_NsfTest.txt -nsf-import-pattern-length:160 -nsf-import-duration:360 -famistudio-txt-bare
