...
..\bin\Release\net5.0\FamiStudio.exe TestEPSM.nsf famistudio-txt-export TestEPSM_NsfTest.txt -nsf-import-pattern-length:160 -nsf-import-duration:170 -famistudio-txt-noversion
