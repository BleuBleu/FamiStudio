..\bin\Release\FamiStudio.exe TestBase.fms unit-test TestBase_FamiStudioRef.txt
..\bin\Release\FamiStudio.exe TestFDS.fms unit-test TestFDS_FamiStudioRef.txt
..\bin\Release\FamiStudio.exe TestMMC5.fms unit-test TestMMC5_FamiStudioRef.txt
..\bin\Release\FamiStudio.exe TestN163.fms unit-test TestN163_FamiStudioRef.txt
...
..\bin\Release\FamiStudio.exe TestEPSM.fms unit-test TestEPSM_FamiStudioRef.txt
