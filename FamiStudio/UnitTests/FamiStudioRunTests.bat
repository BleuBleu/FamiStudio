..\bin\Release\net8.0\FamiStudio.exe TestBase.fms unit-test TestBase_FamiStudioTest.txt
..\bin\Release\net8.0\FamiStudio.exe TestFDS.fms unit-test TestFDS_FamiStudioTest.txt
..\bin\Release\net8.0\FamiStudio.exe TestMMC5.fms unit-test TestMMC5_FamiStudioTest.txt
..\bin\Release\net8.0\FamiStudio.exe TestN163.fms unit-test TestN163_FamiStudioTest.txt
..\bin\Release\net8.0\FamiStudio.exe TestS5B.fms unit-test TestS5B_FamiStudioTest.txt
..\bin\Release\net8.0\FamiStudio.exe TestVRC6.fms unit-test TestVRC6_FamiStudioTest.txt
..\bin\Release\net8.0\FamiStudio.exe TestVRC7.fms unit-test TestVRC7_FamiStudioTest.txt
..\bin\Release\net8.0\FamiStudio.exe TestEPSM.fms unit-test TestEPSM_FamiStudioTest.txt
..\bin\Release\net8.0\FamiStudio.exe TestMulti.fms unit-test TestMulti_FamiStudioTest.txt
..\bin\Release\net8.0\FamiStudio.exe TestFamiTrackerTempo.fms unit-test TestFamiTrackerTempo_FamiStudioTest.txt
